...
class EchoHelper extends HtmlHelper {
    ...
    function periodeBulanSingkatan() {
        return $this->singkatanBulan;
    }

    function singkatanBulan($index) {
        if (!empty($index)) {
            return $this->singkatanBulan[$index];
        }
    }
    ...
    function laporanPeriodeBulan($awal, $akhir) {
        ...
        if (empty($awal) && !empty($akhir)) {
            return "Sampai dengan $tglAkhir $bulanAkhir $tahunAkhir";
        } else if (!empty($awal) && empty($akhir)) {
            return "Dari $tglAwal $bulanAwal $tahunAwal";
        } else if (!empty($awal) && !empty($akhir)) {
