                                ...
                                <tr>
                                    <td colspan="11" style="width:200px">
                                        <div class="form-group">
                                            ...
                                            echo $this->Form->input("CashDisbursement.created_datetime", array("div" => array("class" => "col-sm-4"), "type" => "text", "label" => false, "class" => "form-control", "disabled", 'value' => $this->Html->cvtTanggal($this->data['CashDisbursement']['created_datetime'])));
                                            ?>
                                        </div>
                                    </td>
                                </tr>
                        ...
                        <table class="table table-hover table-bordered stn-table" width="100%">
                            ...
                            <tbody id="target-detail-kas-keluar">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?= $this->Form->input("CashDisbursementDetail.$i.name", array("div" => false, "label" => false, "class" => "form-control", "disabled", "value" => $transaction_name)) ?>
                                    </td>
                                    <td>
                                        <div class="input-group">
                                            <span class="input-group-btn">
