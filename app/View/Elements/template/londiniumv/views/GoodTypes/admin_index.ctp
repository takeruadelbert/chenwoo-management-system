<?php
echo $this->element(_TEMPLATE_DIR . "/{$template}/filter/good-type");
?>
<div class="panel panel-default">
    <div class="panel-body">
        <div class="block-inner text-danger">
            <h6 class="heading-hr"><?= __("DATA KATEGORI BARANG") ?>
    ...
    <div class="modal-dialog modal-lg-6">
        <div class="modal-content">
            ...
            <div class="panel form-horizontal">
                <div class="panel-body">
                    <div class="block-inner text-danger">
                        <h6 class="heading-hr">DATA KATEGORI BARANG 
                            <small class="display-block"><?= _APP_CORPORATE_FULL ?></small>
                        </h6>
                    </div>
                    <!-- Justified pills -->
                        ...
                        <table width="100%" class="table table-hover">
                            <tr>
                                <td colspan="3" style="width:200px">
                                    <div class="form-group">
                                        <?php
                                        echo $this->Form->label("GoodType.parent_name", __("Kategori Barang"), array("class" => "col-sm-3 col-md-4 control-label"));
                                        echo $this->Form->input("GoodType.parent_name", array("div" => array("class" => "col-sm-9 col-md-8"), "label" => false, "class" => "form-control", "disabled"));
                                        ?>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td colspan="3" style="width:200px">
                                    <div class="form-group">
                                        <?php
                                        echo $this->Form->label("GoodType.note", __("Keterangan"), array("class" => "col-sm-3 col-md-4 control-label"));
                                        echo $this->Form->input("GoodType.note", array("div" => array("class" => "col-sm-9 col-md-8"), "label" => false, "class" => "form-control", "disabled"));
                                        ?>
                                    </div>
                                </td>
                            </tr>
...
<script>
    $(document).ready(function () {
        $(".viewData").click(function () {
            ...
            $.ajax({
                url: BASE_URL + "good_types/view_goods_type/" + typeId,
                type: "GET",
                dataType: "JSON",
                data: {},
                success: function (data) {
                    $("#GoodTypeParentName").val(data.Parent.name);
                    $("#GoodTypeName").val(data.GoodType.name);
                    $("#GoodTypeNote").val(data.GoodType.note);
                }
            })
        });
    });
