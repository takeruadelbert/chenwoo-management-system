<?php echo $this->Form->create("MaterialAdditionalSale", array("class" => "form-horizontal form-separate", "action" => "edit", "id" => "formSubmit", "inputDefaults" => array("error" => array("attributes" => array("wrap" => "label", "class" => "error"))))) ?>
                ...
                <div class="table-responsive stn-table">
                    ...
                    <table width="100%" class="table table-hover table-bordered stn-table">
                        ...
                        <tbody id="target-product-data">
                            ...
                            foreach ($this->data['MaterialAdditionalSaleDetail'] as $index => $details) {
                                ...
                                <tr class="dynamic-row">
                                    ...
                                    <td class="text-center">
                                        <select name='data[MaterialAdditionalSaleDetail][<?= $i ?>][material_additional_id]' id="selectProduct<?= $i ?>" class='select-full product_id selectProduct' onchange="change_unit(<?= $i ?>)">
                                    ...
                                    <td class="text-center">
                                        <div class="input-group">
                                            <input type='text' name='data[MaterialAdditionalSaleDetail][<?= $i ?>][quantity]' class='form-control MaterialAdditionalSaleDetail<?= $i ?>Quantity text-right isdecimaldollar' id='quantity<?= $i ?>' value="<?= $details['quantity'] ?>" onkeyup="updateTotal(<?= $i ?>)"/>
                                    ...
                                    <td class="text-center">
                                        <div class="input-group">
                                            ...
                                            <input type='text' name="data[MaterialAdditionalSaleDetail][<?= $i ?>][price]" class='form-control MaterialAdditionalSaleDetail<?= $i ?>Price qtyPrice text-right isdecimal' value="<?= ic_rupiah($details['price']) ?>" id="price<?= $i ?>" onkeyup="updateTotal(<?= $i ?>)"/>
                                        </div>        
                                    </td>  
                                    <td class="text-center">
                                        <?php
                            ...
                            <input type="hidden" name="data[MaterialAdditionalSaleDetail][<?= $i ?>][id]" value="<?= $details['id'] ?>">
                            </tr>
                            <?php
                            $i++;
                            $grandTotal += $subtotal;
                        ...
                        <tfoot>
                            <tr>
                                <td colspan="7">
                                    <a class="text-success firstrunclick"  href="javascript:void(false)" onclick="addThisRow(this, 'product-data', '')" data-n="<?= $i ?>"><i class="icon-plus-circle"></i></a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="1">
                                    <div class="input-group">
                                        <span class="input-group-addon">Rp</span>
                                        <input type="text" class="form-control text-right auto-calculate-grand-total-produk-data" id="grandTotal" name="data[MaterialAdditionalSale][total]" readonly value="<?= ic_rupiah($grandTotal) ?>">
                                    </div>
                                </td>
                                <td></td>
                            </tr>
