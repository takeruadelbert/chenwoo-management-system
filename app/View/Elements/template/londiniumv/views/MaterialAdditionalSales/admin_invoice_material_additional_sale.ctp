                            ...
                            foreach ($data['rows'] as $item) {
                                ...
                                <tr id="row-<?= $i ?>" class="removeRow<?php echo $item["MaterialAdditionalSale"]['id']; ?>">
                                    ...
                                    <td class="text-center">
                                        <a target="_blank" href="<?= Router::url("/admin/{$this->params['controller']}/print_invoice_material_additional_sale/{$item[Inflector::classify($this->params['controller'])]['id']}") ?>"><button type="button" class="btn btn-default btn-xs btn-icon tip" title="Cetak Invoice Penjualan"><i class="icon-print2"></i></button></a>
