<?php echo $this->Form->create("CooperativeCashIn", array("class" => "form-horizontal form-separate", "action" => "view", "id" => "formSubmit", "inputDefaults" => array("error" => array("attributes" => array("wrap" => "label", "class" => "error"))))) ?>
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="block-inner text-danger">
                    <h6 class="heading-hr"><?= __("Lihat Kas Masuk Koperasi") ?>                
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            echo $this->Form->input("CooperativeCashIn.creator_id", array("type" => "hidden", "value" => $this->Session->read("credential.admin.Employee.id")));
                                                            ?>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-9 col-md-8">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control text-right isdecimal" name="data[CooperativeCashIn][amount]" required="required" value="<?= $this->data['CooperativeCashIn']['amount'] ?>" readonly>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        echo $this->Form->input("CooperativeCashIn.cooperative_cash_id", array("div" => array("class" => "col-sm-9 col-md-8"), "label" => false, "class" => "select-full", "empty" => "", "placeholder" => "- Pilih Kas -", "disabled"));
                                                        ?>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        echo $this->Form->input("CooperativeCashIn.created_datetime", array("type" => "text", "div" => array("class" => "col-sm-9 col-md-8"), "label" => false, "class" => "form-control datetime", "value" => $this->data['CooperativeCashIn']['created_datetime'], "disabled"));
                                                        ?>
                                                    </div>
                                                </div>
                                            </div>                                
