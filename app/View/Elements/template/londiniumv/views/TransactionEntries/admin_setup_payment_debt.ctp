<?php echo $this->Form->create("TransactionEntry", array("class" => "form-horizontal form-separate", "action" => "setup_payment_debt/" . $supplier_id, "id" => "formSubmit", "inputDefaults" => array("error" => array("attributes" => array("wrap" => "label", "class" => "error"))))) ?>
                    ...
                    if (empty($data)) {
                        ...
                        foreach ($data as $index => $item) {
                            ...
                            <tr>
                                ...
                                <td class="text-right" style = "border-left-style:none !important" width = "100"><?= ic_rupiah($item["TransactionEntry"]['total']) ?></td>
                                <td class="text-center" style = "border-right-style:none !important" width = "50">Rp. </td>
                                <td class="text-right" style = "border-left-style:none !important" width = "100"><?= ic_rupiah($item["TransactionEntry"]['remaining']) ?></td>
                            ...
                            <input type='hidden' class='transactionEntryId<?= $index ?>' name='data[TransactionEntry][<?= $index ?>][transaction_entry_id]' value='<?= $item['TransactionEntry']['id'] ?>' disabled>
                            <?php
                            $i++;
                        }
                    }
