<?php echo $this->Form->create("Shipment", array("class" => "form-horizontal form-separate", "action" => "add", "id" => "formSubmit", "inputDefaults" => array("error" => array("attributes" => array("wrap" => "label", "class" => "error"))))) ?>
<div class="tab-pane active fade in" id="data-utama">
    <div class="panel panel-default">
        <div class="panel-body">
            <div class="block-inner text-danger">
                <h6 class="heading-hr"><?= __("Penambahan Data Pengiriman") ?>
...
<!--                    <ul class="nav nav-pills nav-justified">
                    ...
                    <div class="tab-content pill-content">
                        <div class="tab-pane fade in active" id="justified-pill0"> <div class="panel-heading" style="background:#2179cc">
                            ...
                            <div id="materialList">
                                <div class="form-group">
                                    ...
                                    <div class= "col-md-4">
                                        <div class="has-feedback">
                                            <input type="text" placeholder="Silahkan Cari Nomor Penjualan ..." class="form-control typeahead-ajax-transaction">
                                            <input type="hidden" name="data[Shipment][sale_id]" id="saleId">
                                ...
                                <div class="form-group">
                                    ...
                                    echo $this->Form->input("Shipment.po_number", array("div" => array("class" => "col-md-4"), "label" => false, "class" => "form-control", "readonly"));
                                    ?> 
                                    <?php
                                    echo $this->Form->label("Dummy.buyer", __("Nama Pembeli"), array("class" => "col-md-2 control-label"));
                                    echo $this->Form->input("Dummy.buyer", array("div" => array("class" => "col-md-4"), "label" => false, "readonly", "class" => "form-control", "id" => "buyerName"));
                                    ?>     
                                </div>
                                <div class="form-group"> 
                                    <?php
...
<script>
    $(document).ready(function () {
        var sale = new Bloodhound({
            ...
            prefetch: '<?= Router::url("/admin/sales/list_shipment", true) ?>',
            remote: {
                url: '<?= Router::url("/admin/sales/list_shipment", true) ?>' + '?q=%QUERY',
                wildcard: '%QUERY',
            }
        });
        ...
        $('input.typeahead-ajax-transaction').typeahead({
            ...
            templates: {
                ...
                suggestion: function (context) {
                    return '<p>Nomor Penjualan Produk : ' + context.sale_no + '<br>Nomor PO : ' + context.po_number + '<br>Nama Pembeli : ' + context.buyer_name + '</p>';
                },
                empty: [
        ...
        $('input.typeahead-ajax-transaction').bind('typeahead:select', function (ev, suggestion) {
            ...
            $('#buyerName').val(suggestion.buyer_name);
            $('#ShipmentPoNumber').val(suggestion.po_number);
            //viewDataBoxes(suggestion.id);
            if (suggestion.buyer_type_id == 1) {
                $('#reg').hide();
            } else if (suggestion.buyer_type_id == 2) {
                $('#reg').show();
            }
        });
    });
