        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="block-inner text-danger">
                    <h6 class="heading-hr"><?= __("Lihat Jenis Jam Kerja") ?>
                    </h6>
                </div>
                <div class="table-responsive">
                        ...
                        <tr>
                            <td colspan="3" style="width:200px">
                                <div class="form-group">
                                    ...
                                    echo $this->Form->input("WorkingHourType.name", array("div" => array("class" => "col-sm-9 col-md-8"), "label" => false, "class" => "form-control", "type" => "text", "disabled"));
                            ...
                            <td colspan="3" style="width:200px">
                                <div class="form-group">
                                    ...
                                    <label class="radio-inline radio-success">
                                        <input type="radio" name="data[WorkingHourType][ignore_holiday]" disabled value="1" class="styled" <?= $this->data['WorkingHourType']['ignore_holiday'] ? "checked" : "" ?>> <b>Ya</b> &nbsp; &nbsp; &nbsp; &nbsp;
                                        <input type="radio" name="data[WorkingHourType][ignore_holiday]" disabled value="0" class="styled" <?= $this->data['WorkingHourType']['ignore_holiday'] ? "" : "checked" ?>> <b>Tidak</b>
                                    </label>
                                </div>
                            </td>
                        </tr>
                                ...
                                <div class="form-group">
                                    ...
                                    foreach ($days as $k => $day) {
                                        ...
                                        <label class="checkbox-inline checkbox-success toggleable-fields " data-name="<?= $day ?>">
                                            <input type="checkbox" class="styled" disabled <?= $unlock ? 'checked' : '' ?> name="data[WorkingHourTypeDetail][<?= $n ?>][day_id]" value='<?php echo $i ?>'> <b><?= $day ?></b> &nbsp;
                                        </label>
                                        <?php
                                        $i++;
                                    }
                    ...
                    foreach ($days as $k => $day) {
                        ...
                        ?>
                        <table width="100%" class="table toggle-disabled <?= $unlock ? '' : 'hidden' ?>" id="data<?= $day ?>">
                            <div class="panel-heading <?= $unlock ? '' : 'hidden' ?>" style="background:#2179cc" id="data<?= $day ?>Field">
                            ...
                            <tr>
                                <td colspan="3" style="width:200px">
                                    <div class="form-group">
                                        <div class="col-sm-6">
                                            <?php
                                            echo $this->Form->input("WorkingHourTypeDetail.$n.id", array("type" => "hidden", "class" => "form-control", "id" => "idSenin", "disabled" => "true"));
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-6">
                                            ...
                                            echo $this->Form->input("WorkingHourTypeDetail.$n.tolerance_late", array("type" => "number", "div" => array("class" => "col-sm-9 col-md-8"), "label" => false, "class" => "form-control", "type" => "text", "disabled" => "true"));
                                            ?>
                                        </div>
                                        <div class="col-sm-6">
                                            <?php
                                            ...
                                            echo $this->Form->input("WorkingHourTypeDetail.$n.tolerance_home_early", array("type" => "number", "div" => array("class" => "col-sm-9 col-md-8"), "label" => false, "class" => "form-control", "type" => "text", "disabled" => "true"));
                                            ?>
                                        </div>
                                    </div>
                                </td>
