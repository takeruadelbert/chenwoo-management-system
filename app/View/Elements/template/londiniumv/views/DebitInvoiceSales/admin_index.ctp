<?php
echo $this->element(_TEMPLATE_DIR . "/{$template}/filter/debit-sale");
?>
<div class="panel panel-default">
    <div class="panel-body">
        <div class="block-inner text-danger">
            <h6 class="heading-hr"><?= __("DATA PENERIMAAN KELEBIHAN") ?>
                ...
                <table width="100%" class="table table-hover table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center" width="250" bgcolor="#FFFFCC" style="color: #000;"><?= __("Status Verifikasi") ?></th>
