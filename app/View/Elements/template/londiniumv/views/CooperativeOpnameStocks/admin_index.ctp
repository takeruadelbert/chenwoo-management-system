<?php
echo $this->element(_TEMPLATE_DIR . "/{$template}/filter/cooperative-stock-opname");
?>
<div class="panel panel-default">
    <div class="panel-body">
        <div class="block-inner text-danger">
            <h6 class="heading-hr"><?= __("DATA STOK OPNAME KOPERASI") ?>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="panel form-horizontal">
                <div class="panel-body">
                    <div class="block-inner text-danger">
                        <h6 class="heading-hr">LIHAT DATA STOK OPNAME KOPERASI
                            <small class="display-block"><?= _APP_CORPORATE_FULL ?></small>
                        </h6>
                    </div>
                    <!-- Justified pills -->
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <?php
                                                echo $this->Form->label("Dummy.name", __("Nama Barang"), array("class" => "col-sm-3 col-md-4 control-label"));
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9 col-md-8">
                                                    <div class="input-group">
                                                        <?php
                                                        echo $this->Form->input("CooperativeOpnameStock.stock_number", array("div" => array("class" => ""), "type" => "text", "label" => false, "id" => "physicStock", "class" => "form-control text-right", "disabled", "id" => "fisik"));
                                                        ?>
                                                        <span class="input-group-addon unit"><strong></strong></span>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9 col-md-8">
                                                    <div class="input-group">
                                                        <?php
                                                        echo $this->Form->input("CooperativeOpnameStock.stock_difference", array("div" => array("class" => ""), "type" => "text", "label" => false, "class" => "form-control text-right", "readonly", "id" => "differ"));
                                                        ?>
                                                        <span class="input-group-addon unit"><strong></strong></span>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                echo $this->Form->input("CooperativeOpnameStock.opname_date", array("div" => array("class" => "col-sm-9 col-md-8"), "label" => false, "type" => "text", "class" => "form-control", "disabled", "id" => "date"));
                                                ?>
                                            </div>
                                        </div>
                                    </div>  
                            ...
                            <tr>
                                <td>
                                    <div class="form-group">
                                        ...
                                        ?>
                                        <div id ="CooperativeOpnameStockNote" style = "padding-top:10px !important;padding-left:165px !important;">
                                        </div>
                                    </div>
                                </td>
                            </tr>
...
<script>
    $(document).ready(function () {
        $(".viewData").click(function () {
            ...
            $.ajax({
                url: BASE_URL + "cooperative_opname_stocks/view_data_opname_stock/" + typeId,
                type: "GET",
                dataType: "JSON",
                data: {},
                success: function (data) {
                    $("#DummyName").val(data.CooperativeGoodList.name);
                    $("#DummyCode").val(data.CooperativeGoodList.code);
                    $("#DummyBarcode").val(data.CooperativeGoodList.barcode);
                    $("#DummyCategory").val(data.CooperativeGoodList.GoodType.name);
                    $("#fisik").val(data.CooperativeOpnameStock.stock_number);
                    $(".unit").html(data.CooperativeGoodList.CooperativeGoodListUnit.name);
                    var stock_fisik = data.CooperativeOpnameStock.stock_number;
                    var selisih = parseInt(data.CooperativeOpnameStock.stock_difference);
                    $("#differ").val(selisih);
                    var stock_sistem = stock_fisik - selisih;
                    $("#sistem").val(stock_sistem);
                    $("#date").val(cvtWaktu(data.CooperativeOpnameStock.opname_date));
                    $('#CooperativeOpnameStockNote').html(data.CooperativeOpnameStock.note);
                }
            })
        });
    });
