...
<div class="panel panel-default">
    <div class="panel-body">
        <div class="block-inner text-danger">
            <h6 class="heading-hr"><?= __("LAPORAN PENDAPATAN KOPERASI") ?>
                <div class="pull-right">
                    <button class="btn btn-xs btn-default" type="button" onclick="exp('print', '<?php echo Router::url("earning/print?" . $_SERVER['QUERY_STRING'], true) ?>')">
                        <i class="icon-print2"></i> 
                        <?= __("Cetak") ?>
                    </button>&nbsp;
                    <button class="btn btn-xs btn-default" type="button" onclick="exp('excel', '<?php echo Router::url("earning/excel?" . $_SERVER['QUERY_STRING'], true) ?>')">
        ...
        <div class="table-responsive">
            <table width="100%" class="table table-bordered">
                <div class="panel-heading" style="background:#2179cc">
                    <h6 class="panel-title" style=" color:#fff"><i class="icon-stats"></i>Laporan Pendapatan </h6></span>
                </div>
                <tbody>
                    <tr>
                        <td colspan="1"><strong><i class="icon-coin" style="color:green;"></i>&nbsp;&nbsp;Total Pendapatan</strong></td>
                        <td class="text-center" style = "border-right-style:none !important" width = "50"><b>Rp.</b></td>
                        ...
                        if (empty($data['rows'][0]['EmployeeDataDeposit']) && empty($data['rows'][0]['EmployeeDataLoan'])) {
                            ...
                            foreach ($data['rows'] as $item) {
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><?= emptyToStrip(@$item['Employee']['Department']['name']) ?></td>
