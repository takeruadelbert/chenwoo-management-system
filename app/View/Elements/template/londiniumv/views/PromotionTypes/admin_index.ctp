<?php
echo $this->element(_TEMPLATE_DIR . "/{$template}/filter/promotion-type");
?>
<div class="panel panel-default">
    <div class="panel-body">
        <div class="block-inner text-danger">
            <h6 class="heading-hr"><?= __("DATA JENIS KENAIKAN PANGKAT") ?>
    ...
    <div class="modal-dialog modal-lg-6">
        <div class="modal-content">
            ...
            <div class="panel form-horizontal">
                <div class="panel-body">
                    <div class="block-inner text-danger">
                        <h6 class="heading-hr">LIHAT DATA JENIS KENAIKAN PANGKAT
                            <small class="display-block"><?= _APP_CORPORATE_FULL ?></small>
                        </h6>
                    </div>
                    <!-- Justified pills -->
                            ...
                            <tr>
                                <td colspan="3" style="width:200px">
                                    <div class="form-group">
                                        ...
                                        echo $this->Form->input("PromotionType.name", array("div" => array("class" => "col-sm-9 col-md-8"), "label" => false, "class" => "form-control", "disabled"));
                                        ?>
                                    </div>
                                </td>
                            </tr>
...
<script>
    $(document).ready(function () {
        $(".viewData").click(function () {
            ...
            $.ajax({
                url: BASE_URL + "promotion_types/view_promotion_type/" + typeId,
                type: "GET",
                dataType: "JSON",
                data: {},
                success: function (data) {
                    $("#PromotionTypeName").val(data.PromotionType.name);
                }
            })
        });
    });
