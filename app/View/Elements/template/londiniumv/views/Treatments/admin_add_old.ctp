                                    ...
                                    <td colspan="3" style="width:200px">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-2 control-label">
                                                <label>Nomor Pembekuan</label>
                                            </div>
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control typeahead-ajax" id="transactionNumber" disabled>
                                                <input type="hidden" name="data[Treatment][freeze_id]" id="freezeId">
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="3" style="width:200px">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="input-group">
                                                    <input type="text" class="form-control text-right" id="ratioPembekuan" readonly>
    ...
    function getFreezeData(freezeId) {
        $.ajax({
            ...
            success: function (data) {
                ...
                $('input#beratPembekuan').val(data.Freeze.total_weight);
...
<script>
    ...
    function addThisRow(e, t, optFunc) {
        ...
        var options = {i: 2, n: n, data_product: data_product, rejected_grade_type: rejected_grade_type};
    ...
    function getTotalBerat(n) {
        $("#treatmentWeight" + n).on("change keyup", function () {
            ...
            var totalDifferWeight = Math.abs(totalBerat - totalFreezeWeight);
            $(".totalDifferWeight").val(totalDifferWeight.toFixed(2));

            /* set the ratio result */
            var ratio = totalBerat / totalFreezeWeight * 100;
