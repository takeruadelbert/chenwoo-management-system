<?php echo $this->Form->create("PaymentSale", array("class" => "form-horizontal form-separate", "action" => "payment_sale_setup", "id" => "formSubmit", "inputDefaults" => array("error" => array("attributes" => array("wrap" => "label", "class" => "error"))))) ?>
