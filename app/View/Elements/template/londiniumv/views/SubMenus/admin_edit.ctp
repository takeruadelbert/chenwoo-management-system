<?php echo $this->Form->create("SubMenu", array("class" => "form-horizontal form-separate", "action" => "edit", "id" => "formSubmit", "inputDefaults" => array("error" => array("attributes" => array("wrap" => "label", "class" => "error"))))) ?>
<div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            echo $this->Form->input("SubMenu.module_id", array("div" => array("class" => "col-sm-9 col-md-8"), "label" => false, "class" => "select-full", "empty" => "", "placeholder" => "- Pilih Modul -"));
                                            ?>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            echo $this->Form->input("SubMenu.menu_id", array("div" => array("class" => "col-sm-9 col-md-8"),"data-autolist-target"=>"#SubMenuParentId", "data-autolist-url" => Router::url("/admin/sub_menus/list_by_menu/", true), "data-autolist-emptylabel" => "Tidak Ada", "label" => false, "class" => "select-full autolist", "empty" => "", "placeholder" => "- Pilih Menu -"));
                                            ?>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            echo $this->Form->input("SubMenu.parent_id", array("div" => array("class" => "col-sm-9 col-md-8"), "label" => false, "class" => "select-full", "empty" => "", "options" => $parents[$this->data["Menu"]["label"]], "placeholder" => "- Pilih Parent -"));
                                            ?>
                                        </div>
                                    </div>
                                </div>
