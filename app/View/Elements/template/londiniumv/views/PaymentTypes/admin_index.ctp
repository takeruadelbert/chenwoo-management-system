<?php
echo $this->element(_TEMPLATE_DIR . "/{$template}/filter/payment-type");
?>
<div class="panel panel-default">
    <div class="panel-body">
        <div class="block-inner text-danger">
            <h6 class="heading-hr"><?= __("DATA TIPE PEMBAYARAN") ?>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="panel form-horizontal">
                <div class="panel-body">
                    <div class="block-inner text-danger">
                        <h6 class="heading-hr">;LIHAT DATA TIPE PEMBAYARAN
                            ...
                            <tr>
                                <td colspan="3" style="width:200px">
                                    <div class="form-group">
                                        ...
                                        echo $this->Form->input("PaymentType.name", array("div" => array("class" => "col-sm-9 col-md-8"), "label" => false, "class" => "form-control", "disabled"));
                                        ?>
                                    </div>
                                </td>
                            </tr>
...
<script>
    $(document).ready(function () {
        $(".viewData").click(function () {
            ...
            $.ajax({
                url: BASE_URL + "payment_types/view_payment_type/" + typeId,
                type: "GET",
                dataType: "JSON",
                data: {},
                success: function (data) {
                    $("#PaymentTypeName").val(data.PaymentType.name);
                }
            })
        });
    });
