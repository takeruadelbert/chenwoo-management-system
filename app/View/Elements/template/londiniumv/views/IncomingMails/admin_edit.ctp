<?php echo $this->Form->create("IncomingMail", array("class" => "form-horizontal form-separate", "type" => "file", "action" => "edit", "id" => "formSubmit", "inputDefaults" => array("error" => array("attributes" => array("wrap" => "label", "class" => "error"))))) ?>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                echo $this->Form->input("IncomingMail.mail_type_id", array("div" => array("class" => "col-md-8"), "label" => false, "class" => "select-full", "empty" => "- Pilih Jenis Surat -"));
                                ?>
                            </div>
                            <div class="form-group">
                                <?php
                                echo $this->Form->label("IncomingMail.mail_classification_id", __("Klasifikasi Surat"), array("class" => "col-md-4 control-label"));
                                echo $this->Form->input("IncomingMail.mail_classification_id", array("div" => array("class" => "col-md-8"), "label" => false, "class" => "select-full", "empty" => "- Pilih Klasifikasi Surat -"));
                                ?>
                            </div>
                            <div class="form-group">
                                <?php
                                echo $this->Form->label("IncomingMail.mail_urgency_id", __("Sifat Surat"), array("class" => "col-md-4 control-label"));
                                echo $this->Form->input("IncomingMail.mail_urgency_id", array("div" => array("class" => "col-md-8"), "label" => false, "class" => "select-full", "empty" => "- Pilih Sifat Surat -"));
                                ?>
                            </div>
                            <div class="form-group">
                                <?php
                                echo $this->Form->label("IncomingMail.mail_origin_id", __("Asal Surat"), array("class" => "col-md-4 control-label"));
                                echo $this->Form->input("IncomingMail.mail_origin_id", array("div" => array("class" => "col-md-8"), "label" => false, "class" => "select-full", "empty" => "- Pilih Asal Surat -"));
                                ?>
                            </div>
                            <div class="form-group">
                                <?php
                                echo $this->Form->label("IncomingMail.mail_rack_id", __("Rak Surat"), array("class" => "col-md-4 control-label"));
                                echo $this->Form->input("IncomingMail.mail_rack_id", array("div" => array("class" => "col-md-8"), "label" => false, "class" => "select-full", "empty" => "- Pilih Rak Surat -"));
                                ?>
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                ?>
                                <div class="col-sm-8">
                                    <textarea rows="5" cols="5" class="limited form-control" placeholder="Limited to 100 characters" name="data[IncomingMail][catatan]"><?= $this->data['IncomingMail']['catatan'] ?></textarea>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-bordered stn-table" width="100%">
                            ...
                            <tbody id="target-penerima">
                                <?php
                                if (!empty($this->data['MailRecipient'])) {
                                    foreach ($this->data['MailRecipient'] as $k => $mailRecipient) {
                                        ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?= $this->Form->hidden("MailRecipient.$k.employee_id", ["class" => "target-value"]) ?>
                                                <?= $this->Form->input("MailRecipient.$k.Employee.Account.Biodata.full_name", array("div" => false, "label" => false, "class" => "form-control", "disabled")) ?>
                                            </td>
                                            <td>
                                                <?= $this->Form->input("MailRecipient.$k.Employee.nip_baru", array("div" => false, "label" => false, "class" => "form-control", "disabled")) ?>
                                            </td>
                                            <td>
                                                <?= $this->Form->input("MailRecipient.$k.Employee.Department.name", array("div" => false, "label" => false, "class" => "form-control", "disabled")) ?>
                                            </td>
                                            <td>
                                                <?= $this->Form->input("MailRecipient.$k.Employee.Office.name", array("div" => false, "label" => false, "class" => "form-control", "disabled")) ?>
                                            </td>
                                            <td>
                                                <?= $this->Form->input("MailRecipient.$k.Employee.UnitPosition.eselon", array("div" => false, "label" => false, "class" => "form-control", "disabled")) ?>
                                            </td>
