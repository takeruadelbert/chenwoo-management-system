<?php echo $this->Form->create("TreatmentProduct", array("class" => "form-horizontal form-separate", "action" => "edit", "id" => "formSubmit", "inputDefaults" => array("error" => array("attributes" => array("wrap" => "label", "class" => "error"))))) ?>
<div class="tab-pane active fade in" id="data-utama">
    <div class="panel panel-default">
        <div class="panel-body">
            <div class="block-inner text-danger">
                <h6 class="heading-hr"><?= __("Ubah Produk Treatment") ?>
                </h6>
            </div>
                    ...
                    <div class = "col-md-6">
                        ...
                        <div class="col-sm-9 col-md-8">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control text-right isdecimal" name="data[TreatmentProduct][price]" value="<?= $this->data['TreatmentProduct']['price'] ?>">
                            </div>
                        </div>
                    </div>
                    <div class = "col-md-6">
