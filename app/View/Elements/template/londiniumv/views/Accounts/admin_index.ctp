...
<div class="panel panel-default">
    <div class="panel-body">
        <div class="block-inner text-danger">
            <h6 class="heading-hr"><?= __("DATA PENGGUNA APLIKASI") ?>
                            ...
                            foreach ($data['rows'] as $item) {
                                ...
                                <tr id="row-<?= $i ?>" class="removeRow<?php echo $item[Inflector::classify($this->params['controller'])]['id']; ?>">
                                    ...
                                    <td class="text-center">
                                        <a href="<?= Router::url("/admin/{$this->params['controller']}/changesomeonepassword/{$item[Inflector::classify($this->params['controller'])]['id']}") ?>">
                                                <button type="button" class="btn btn-default btn-xs btn-icon tip" title="Ubah Kata Sandi"><i class="icon-lock3"></i></button>
                                            </a>
                                            <a href="<?= Router::url("/admin/{$this->params['controller']}/edit_usergroup/{$item[Inflector::classify($this->params['controller'])]['id']}") ?>">
                                                <button type="button" class="btn btn-default btn-xs btn-icon tip" title="Ubah User Group"><i class="icon-pencil"></i></button>
                                            </a>
                                    </td>
                                </tr>
                                <?php
