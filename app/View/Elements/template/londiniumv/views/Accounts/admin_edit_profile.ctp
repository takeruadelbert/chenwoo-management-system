...
<div class="panel panel-default">
    <div class="panel-body">
        <div class="block-inner text-danger">
            <h6 class="heading-hr"><?= __("Ubah Profil") ?>
            </h6>
        </div>
                    ...
                    <td colspan="3" style="width:200px">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <?php
                                    echo $this->Form->label("profile_picture", __("Foto"), array("class" => "col-sm-3 col-md-4 control-label"));
                                    echo $this->Form->input("profile_picture", array("div" => array("class" => "col-sm-9 col-md-8"), "label" => false, "class" => "form-control", "type" => "file"));
                                    ?>
                                </div>
                            </div>
                        </div>
