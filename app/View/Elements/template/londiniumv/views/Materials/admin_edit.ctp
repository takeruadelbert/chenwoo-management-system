<?php echo $this->Form->create("Material", array("class" => "form-horizontal form-separate", "action" => "edit", "type" => "file", "id" => "formSubmit", "inputDefaults" => array("error" => array("attributes" => array("wrap" => "label", "class" => "error"))))) ?>
<div class="tab-pane active fade in" id="data-utama">
    <div class="panel panel-default">
        <div class="panel-body">
            <div class="block-inner text-danger">
                <h6 class="heading-hr"><?= __("Ubah Material") ?>
            ...
            <div class = "row">
                ...
                <div class = "col-md-6">
                    <div class="form-group">
                        ...
                        echo $this->Form->input("Material.material_category_id", array("div" => array("class" => "col-md-9"), "label" => false, "class" => "select-full", "empty" => "- Pilih Kategori -"));
                        ?>
                    </div>  
                </div>  
            </div>
            <div class="stn-table">
                <table width="100%" class="table table-hover table-bordered">
                    ...
                    <tbody id="target-material-data">
                        <?php
                        foreach ($this->data["MaterialDetail"] as $k => $materialDetail) {
                            ?>
                            <tr>
                                <td class="text-center"><?= $k + 1 ?></td>
                                <td class="text-center">
                                    <?= $this->Form->input("MaterialDetail.$k.name", array("div" => false, "label" => false, "class" => "form-control")); ?>
                                    <?= $this->Form->hidden("MaterialDetail.$k.id"); ?>
                                </td>
                                <td class="text-center">
                                    <?= $this->Form->input("MaterialDetail.$k.unit_id", array("div" => false, "label" => false, "class" => "form-control")); ?>
                                </td>
                                <td class="text-center">
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="4">
                                <a class="text-success"  href="javascript:void(false)" onclick="addThisRow(this, 'material-data', '')" data-n="<?= count($this->data["MaterialDetail"]) ?>"><i class="icon-plus-circle"></i></a>
                            </td>
                        </tr>
                </table>
            </div>
