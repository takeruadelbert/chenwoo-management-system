<?php echo $this->Form->create("State", array("class" => "form-horizontal form-separate", "action" => "add", "id" => "formSubmit", "inputDefaults" => array("error" => array("attributes" => array("wrap" => "label", "class" => "error"))))) ?>
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="block-inner text-danger">
                    <h6 class="heading-hr"><?= __("Tambah State") ?>
                    ...
                    <table width="100%" class="table table-bordered table-hover">
                        ...
                        <tfoot>
                            <tr class="addrowborder">
                                <td colspan="4" align="left"><a href="javascript:void(false)" onclick="addThisRow($(this), 'modullink', 'anakOptions')" data-n="1"><i class="icon-plus-circle"></i></a></td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
