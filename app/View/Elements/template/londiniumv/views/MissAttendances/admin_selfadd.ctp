<?php echo $this->Form->create("MissAttendance", array("class" => "form-horizontal form-separate", "action" => "selfadd", "id" => "formSubmit", "inputDefaults" => array("error" => array("attributes" => array("wrap" => "label", "class" => "error"))))) ?>
<div class="panel panel-default">
    <div class="panel-body">
        <div class="block-inner text-danger">
            <h6 class="heading-hr"><?= __("FORM PERMOHONAN LUPA ABSEN") ?>
                <small class="display-block">Mohon Isikan Form Permohonan Lupa Absen Dengan Sesuai dan Benar</small>
            </h6>
        </div>
        ...
        <div class="table-responsive">
            <table width="100%" class="table">
                <div class="panel-heading" style="background:#2179cc">
                    <h6 class="panel-title" style=" color:#fff"><i class="icon-menu2"></i><?= __("Periode Lupa Absen") ?></h6>
                </div>
                <tr>
        ...
        <div class="row">
                    ...
                    <table width="100%" class="table table-hover table-bordered">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="has-feedback">
                                    <?php
                                    echo $this->Form->input("MissAttendance.name", array("div" => false, "label" => false, "class" => "form-control typeahead-ajax"));
                                    ?>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                ?>
                                <?php
                                echo $this->Form->input("MissAttendance.supervisor_id", array("type" => "hidden", "class" => "form-control"));
                                ?>
                            </td>
                        </tr>
                        <tr>
            ...
            <div class="col-md-6">
                ...
                <br/>
                <textarea rows="5" cols="5" class="form-control editor" name="data[MissAttendance][note]"></textarea>
            </div>
        </div>
    </div>
</div>
...
<script>
    $(document).ready(function () {
        ...
        $('input.typeahead-ajax').bind('typeahead:select', function (ev, suggestion) {
            ...
            $('#MissAttendanceSupervisorId').val(suggestion.id);
