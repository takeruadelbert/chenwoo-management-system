<?php echo $this->Form->create("ShipmentAgent", array("class" => "form-horizontal form-separate", "action" => "edit", "type" => "file", "id" => "formSubmit", "inputDefaults" => array("error" => array("attributes" => array("wrap" => "label", "class" => "error"))))) ?>
<div class="tab-pane active fade in" id="data-utama">
    <div class="panel panel-default">
        <div class="panel-body">
            <div class="block-inner text-danger">
                <h6 class="heading-hr"><?= __("Ubah Agen Pengiriman") ?>
                                    ...
                                    <tr>
                                        <td colspan="3" style="width:200px">
                                            <div class="form-group">
                                                ...
                                                echo $this->Form->input("ShipmentAgent.employee_id", ["type" => "hidden", "value" => $this->data['Employee']['id']]);
                                                ?>
                                                <?php
                        ...
                        <div class="tab-pane fade" id="justified-pill3">
                            <table class="table table-hover table-bordered stn-table" width="100%">
                                ...
                                <tbody id="target-detail-perbankan-buyer"> <?php
                                    $no = 1;
                                    $dataN = count($this->data["ShipmentAgentBank"]);
                                    foreach ($this->data["ShipmentAgentBank"] as $i => $value) {
                                        ?>
                                        <tr class="dynamic-row">
                                            <td class="nomorIdx text-center"><?= $no; ?></td>
                                            <td>
                                                <?php
                                                echo $this->Form->input("ShipmentAgentBank.$i.id", array("div" => false, "label" => false, "type" => "hidden", "class" => false));
                                                echo $this->Form->input("ShipmentAgentBank.$i.bank_name", array("div" => false, "label" => false, "class" => "form-control", "maxlength" => "255"));
                                                ?>
                                            </td>
                                            <td>
                                                <?php
                                                echo $this->Form->input("ShipmentAgentBank.$i.bank_code", array("div" => false, "label" => false, "class" => "form-control", "maxlength" => "255"));
                                                ?>
                                            </td>
                                            <td>
                                                <?php
                                                echo $this->Form->input("ShipmentAgentBank.$i.bank_branch", array("div" => false, "label" => false, "class" => "form-control", "maxlength" => "255"));
                                                ?>
                                            </td>
                                            <td>
                                                <?php
                                                echo $this->Form->input("ShipmentAgentBank.$i.on_behalf", array("div" => false, "label" => false, "class" => "form-control", "maxlength" => "255"));
                                                ?>
                                            </td>
