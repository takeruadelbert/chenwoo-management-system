...
<div class="panel panel-default">
    <div class="panel-body">
        <div class="block-inner text-danger">
            <h6 class="heading-hr"><?= __("PEMBAYARAN GAJI HARIAN") ?>
                <div class="pull-right">
                    <button class="btn btn-xs btn-default" title="Print Data" type="button" onclick="exp('print', '<?php echo Router::url("cashier_confirm_harian/print?" . $_SERVER['QUERY_STRING'], true) ?>')">
                        <i class="icon-print2"></i>
                        Print
                    </button>&nbsp;
                    <button class="btn btn-xs btn-default" title="Ekspor Ke Excel" type="button" onclick="exp('excel', '<?php echo Router::url("cashier_confirm_harian/excel?" . $_SERVER['QUERY_STRING'], true) ?>')">
                        ...
                        <tr>
                            <td colspan="3" style="width:200px">
                                <div class="form-group">
                                    ...
                                    echo $this->Form->input("EmployeeSalary.period", array("div" => array("class" => "col-sm-4"), "label" => false, "class" => "form-control datepicker", "type" => "text", "readonly"));
                                    ?>
                                </div>
                            </td>
                        </tr>
