                ...
                <table width="100%" class="table table-hover table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center" width="8%" bgcolor="#FFFFCC" style="color: #000;"><?= __("Keterangan") ?></th>
                            <th class="text-center" width="8%" bgcolor="#FFFFCC" style="color: #000;"><?= __("Tipe Pegawai") ?></th>
                            ...
                            <th class="text-center" width="8%" bgcolor="#FFFFCC" style="color: #000;"><?= __("Tanggal Validasi") ?></th>
                            <th class="text-center" width="8%" bgcolor="#FFFFCC" style="color: #000;"><?= __("Divalidasi Oleh") ?></th>
                            <th class="text-center" width="8%" bgcolor="#FFFFCC" style="color: #000;"><?= __("Status Validasi") ?></th>
                            <th class="text-center" width="5%" bgcolor="#FFFFCC" style="color: #000;"><?= __("Aksi") ?></th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                                ...
                                <tr id="row-<?= $i ?>" class="removeRow<?php echo $item[Inflector::classify($this->params['controller'])]['id']; ?>">
                                    ...
                                    <td class="text-center">
                                        ...
                                        if ($item['EmployeeSalary']['validate_status_id'] === '2') {
                                            ...
                                            ?>
                                            <button class = "btn btn-default btn-xs btn-icon btn-icon tip" title = "Print Slip Gaji" disabled><i class = "icon-print2"></i></button>
                                            <?php
                                        }
                                        ?>
                                    </td>
                        ...
                        <tr class = "harian">
                            <td colspan="3" style="width:200px">
                                <div class="form-group">
                                    ...
                                    echo $this->Form->input("EmployeeSalary.start_date_period", array("div" => array("class" => "col-sm-4"), "id" => "startDate", "type" => "text", "label" => false, "class" => "form-control datepicker", "readonly"));
                                    ?>
                                    <?php
                                    echo $this->Form->label("EmployeeSalary.end_date_period", __("Periode Tanggal Akhir"), array("class" => "col-sm-2 control-label"));
                                    echo $this->Form->input("EmployeeSalary.end_date_period", array("div" => array("class" => "col-sm-4"), "id" => "endDate", "type" => "text", "label" => false, "class" => "form-control datepicker", "readonly"));
                                    ?>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td colspan="3" style="width:200px">
                                <div class="form-group">
                                    ...
                                    echo $this->Form->input("EmployeeSalary.note", array("div" => array("class" => "col-sm-10"), "label" => false, "class" => "form-control", "readonly"));
                                    ?>
                                </div>
                            </td>
                        </tr>
        ...
        $('.viewData').click(function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('textarea#EmployeeSalaryNote').val(data.EmployeeSalary.note);
                    if (data.Employee.employee_type_id == 1) {
                        $('.harian').show();
                        $('.bulanan').hide();
                        $('input#EmployeeSalaryStartDatePeriod').val(cvtTanggal(data.EmployeeSalary.start_date_period));
                        $('input#EmployeeSalaryEndDatePeriod').val(cvtTanggal(data.EmployeeSalary.end_date_period));
                    } else if (data.Employee.employee_type_id == 2) {
                        $('.harian').hide();
                        $('.bulanan').show();
