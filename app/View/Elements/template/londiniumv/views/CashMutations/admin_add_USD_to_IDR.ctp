<?php echo $this->Form->create("CashMutation", array("class" => "form-horizontal form-separate", "action" => "add_USD_to_IDR", "id" => "formSubmit", "inputDefaults" => array("error" => array("attributes" => array("wrap" => "label", "class" => "error"))))) ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9 col-md-8">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="number" label="false" class="form-control text-right" required="required" id="nominalDollar" name="data[CashMutation][nominal_dollar]">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9 col-md-8">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" label="false" class="form-control text-right isdecimal" name="data[CashMutation][nominal]" required="required" id="nominalRupiah">
                                                            <span class="input-group-btn">
                                                                <button class="btn btn-default" type="button">,00.</button>
                                                            </span>
                                                        </div>
...
<script>
    $(document).ready(function () {
        ...
        $('input.typeahead-ajax-transfer-cash').bind('typeahead:select', function (ev, suggestion) {
            ...
            $("#DummyAccount").val(suggestion.code);
        ...
        $("#nominalKurs").on("change keyup", function () {
            ...
            var nominalDollar = $("#nominalDollar").val();
            var result = parseInt(nominalKurs * nominalDollar);
            $("#nominalRupiah").val(IDR(result));
        });

        $("#nominalDollar").on("change keyup", function () {
            var nominalKurs = replaceAll($("#nominalKurs").val(), ".", "");
            var nominalDollar = $(this).val();
            var result = parseInt(nominalKurs * nominalDollar);
            $("#nominalRupiah").val(IDR(result));
        });
    });
