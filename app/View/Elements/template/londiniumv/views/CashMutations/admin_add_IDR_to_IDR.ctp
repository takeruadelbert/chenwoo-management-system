<?php echo $this->Form->create("CashMutation", array("class" => "form-horizontal form-separate", "action" => "add_IDR_to_IDR", "id" => "formSubmit", "inputDefaults" => array("error" => array("attributes" => array("wrap" => "label", "class" => "error"))))) ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9 col-md-8">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" label="false" class="form-control text-right isdecimal" required="required" name="data[CashMutation][nominal]">
                                                            <span class="input-group-btn">
        ...
        $('input.typeahead-ajax-transfer-cash').typeahead({
            ...
            templates: {
                ...
                suggestion: function (context) {
                    return '<p> Nama Kas : ' + context.name + '<br>Nomor Rekening : ' + context.code + '<br> Saldo : Rp ' + ic_rupiah(context.nominal) + '<br>Atas Nama : ' + context.on_behalf + '<br>Bank : ' + context.bank_account_type + '</p>';
                },
                empty: [
