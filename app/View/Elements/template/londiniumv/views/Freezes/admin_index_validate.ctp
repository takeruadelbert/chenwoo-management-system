<?php
echo $this->element(_TEMPLATE_DIR . "/{$template}/filter/freeze_validate");
?>
<div class="panel panel-default">
    <div class="panel-body">
        <div class="block-inner text-danger">
            <h6 class="heading-hr"><?= __("NOTIFIKASI STYLING YANG TIDAK MEMENUHI RATIO") ?>
                                ...
                                <tr id="row-<?= $i ?>" class="removeRow<?php echo $item[Inflector::classify($this->params['controller'])]['id']; ?>">
                                    ...
                                    <td class="text-center"  id = "target-change-status<?= $i ?>">
                                        ...
                                        if ($item['Freeze']['verify_status_id'] == 2) {
                                            ...
                                            echo $this->Html->changeStatusSelect($item['Freeze']['id'], ClassRegistry::init("VerifyStatus")->find("list", array("fields" => array("VerifyStatus.id", "VerifyStatus.name"))), $item['Freeze']['verify_status_id'], Router::url("/admin/freezes/change_status_verify"), "#target-change-status$i");
                                        }
                                        ?>
                                    </td>
                    ...
                    <div class="well block">
                        <div class="tabbable">
                            <ul class="nav nav-pills nav-justified">
                                <li class="active"><a href="#justified-pill1" data-toggle="tab"><i class="icon-user"></i> Data Penanggungjawab</a></li>
                                    ...
                                    <table class="table table-hover table-bordered stn-table" width="100%">
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                </td><td class="text-right auto-calculate-grand-total-weight" id = "grandTotal" style="border-right-style:none;">
                                                </td> 
                                            ...
                                            <tr>
                                                ...
                                                </td><td class="text-right auto-calculate-grand-total-ratio tip" id="ratios" style="border-right-style:none;">
                                                </td> 
                                                <td class = "text-left" style= "width:50px; border-left-style:none;">
                                                    %
                                                </td>
            ...
            success: function (data) {
                if (data != null && data != '') {
                    ...
                    $.each(temp.MaterialEntryGrade, function (index, item) {
                        ...
                        total_quantity += parseInt(item.weight);
                        $('#conversion_weight').val(IDR(total_quantity));
