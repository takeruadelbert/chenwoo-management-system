<?php
echo $this->element(_TEMPLATE_DIR . "/{$template}/filter/earning-type");
?>
<div class="panel panel-default">
    <div class="panel-body">
        <div class="block-inner text-danger">
            <h6 class="heading-hr"><?= __("DATA JENIS PEMASUKAN") ?>
                        ...
                        if (empty($data['rows'])) {
                            ...
                            foreach ($data['rows'] as $item) {
                                ...
                                <tr id="row-<?= $i ?>" class="removeRow<?php echo $item[Inflector::classify($this->params['controller'])]['id']; ?>">
                                    ...
                                    <td class="text-left"><?= $item['EarningType']['name'] ?></td>
    ...
    <div class="modal-dialog modal-lg-6">
        <div class="modal-content">
            ...
            <div class="panel form-horizontal">
                <div class="panel-body">
                    <div class="block-inner text-danger">
                        <h6 class="heading-hr">LIHAT DATA JENIS PEMASUKAN
                            ...
                            <tr>
                                <td colspan="3" style="width:200px">
                                    <div class="form-group">
                                        ...
                                        echo $this->Form->input("EarningType.name", array("div" => array("class" => "col-sm-9 col-md-8"), "label" => false, "class" => "form-control", "disabled"));
                                        ?>
                                    </div>
                                </td>
                            </tr>
...
<script>
    $(document).ready(function() {
        $(".viewData").click(function() {
           ...
           $.ajax({
               url: BASE_URL + "earning_types/view_earning_type/" + typeId,
               type: "GET",
               dataType: "JSON",
               data: {},
               success: function(data) {
                   $("#EarningTypeName").val(data.EarningType.name);
               }
           })
        });
    });
