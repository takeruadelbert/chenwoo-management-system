        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="block-inner text-danger">
                    <h6 class="heading-hr"><?= __("Lihat Data Transaksi Angsuran") ?>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-group">
                                                ...
                                                echo $this->Form->input("EmployeeDataLoanDetail.note", array("div" => array("class" => "col-sm-10"), "label" => false, "class" => "ckeditor-fix", "disabled"));
                                                ?>
                                            </div>
                                        </td>
                                    </tr>
