<?php
echo $this->element(_TEMPLATE_DIR . "/{$template}/filter/cooperative-supplier-type");
?>
<div class="panel panel-default">
    <div class="panel-body">
        <div class="block-inner text-danger">
            <h6 class="heading-hr"><?= __("DATA TIPE SUPPLIER KOPERASI") ?>
                        ...
                        if (empty($data['rows'])) {
                            ...
                            foreach ($data['rows'] as $item) {
                                ...
                                <tr id="row-<?= $i ?>" class="removeRow<?php echo $item[Inflector::classify($this->params['controller'])]['id']; ?>">
                                    ...
                                    <td class="text-center"><?= $item['CooperativeSupplierType']['name'] ?></td>
    ...
    <div class="modal-dialog modal-lg-6">
        <div class="modal-content">
            ...
            <div class="panel form-horizontal">
                <div class="panel-body">
                    <div class="block-inner text-danger">
                        <h6 class="heading-hr">DATA TIPE SUPPLIER
                            <small class="display-block"><?= _APP_CORPORATE_FULL ?></small>
                        </h6>
                    </div>
                    <!-- Justified pills -->
                            ...
                            <tr>
                                <td colspan="3" style="width:200px">
                                    <div class="form-group">
                                        ...
                                        echo $this->Form->input("CooperativeSupplierType.name", array("div" => array("class" => "col-sm-9 col-md-8"), "label" => false, "class" => "form-control", "disabled"));
                                        ?>
                                    </div>
                                </td>
                            </tr>
...
<script>
    $(document).ready(function () {
        $(".viewData").click(function () {
            ...
            $.ajax({
                url: BASE_URL + "cooperative_supplier_types/view_supplier_type/" + typeId,
                type: "GET",
                dataType: "JSON",
                data: {},
                success: function (data) {
                    $("#CooperativeSupplierTypeName").val(data.CooperativeSupplierType.name);
                }
            })
        });
    });
