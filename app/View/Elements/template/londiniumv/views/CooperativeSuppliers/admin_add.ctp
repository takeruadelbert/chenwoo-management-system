<?php echo $this->Form->create("CooperativeSupplier", array("class" => "form-horizontal form-separate", "action" => "add", "id" => "formSubmit", "inputDefaults" => array("error" => array("attributes" => array("wrap" => "label", "class" => "error"))))) ?>
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="block-inner text-danger">
                    <h6 class="heading-hr"><?= __("Tambah Data Supplier Koperasi") ?>
                ...
                <div class="well block">
                    <div class="tabbable">
                        <ul class="nav nav-pills nav-justified">
                            <li class="active"><a href="#justified-pill1" data-toggle="tab"><i class="icon-office"></i> Data Supplier <span class="label label-danger">Langkah 1</span></a></li>
                            <li><a href="#justified-pill2" data-toggle="tab"><i class="icon-user"></i> Kontak Person <span class="label label-danger">Langkah 2</span></a></li>
                            <li><a href="#justified-pill3" data-toggle="tab"><i class="icon-file"></i> Data Perbankan <span class="label label-danger">Langkah 3</span></a></li>
                        </ul>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            echo $this->Form->input("CooperativeSupplier.city_id", array("div" => array("class" => "col-sm-9 col-md-8"), "label" => false, "class" => "select-full", "options" => [], "empty" => "", "placeholder" => "- Pilih Kota -"));
                                                            ?>
                                                        </div>
                                                    </div>
                                                </div>
