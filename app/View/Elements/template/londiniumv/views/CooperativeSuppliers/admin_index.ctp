<?php
echo $this->element(_TEMPLATE_DIR . "/{$template}/filter/coop-supplier");
?>
<div class="panel panel-default">
    <div class="panel-body">
        <div class="block-inner text-danger">
            <h6 class="heading-hr"><?= __("Data Supplier Koperasi") ?>
                            ...
                            foreach ($data['rows'] as $item) {
                                ...
                                <tr id="row-<?= $i ?>" class="removeRow<?php echo $item[Inflector::classify($this->params['controller'])]['id']; ?>">
                                    ...
                                    <td class="text-center">
                                        <a data-toggle="modal" href="<?= Router::url("/admin/popups/content?content=viewcoopsupplier&supplierid={$item[Inflector::classify($this->params['controller'])]['id']}") ?>" role="button" data-target="#default-view-coop-supplier" class="btn btn-default btn-xs btn-icon btn-icon tip viewData" title="Lihat Data"><i class="icon-eye7"></i></a>
...
<script>
    $(document).ready(function () {
        $("#default-view-coop-supplier").on("show.bs.modal", function (e) {
