<?php
echo $this->element(_TEMPLATE_DIR . "/{$template}/filter/agenda-departemen");
?>
<div class="panel panel-default">
    <div class="panel-body">
        <div class="block-inner text-danger">
            <h6 class="heading-hr"><?= __("DATA AGENDA PERUSAHAAN") ?>
                            ...
                            foreach ($data['rows'] as $data) {
                                foreach ($data as $item) {
                                    ...
                                    <tr id="row-<?= $i ?>" class="removeRow<?php echo $item['id']; ?>">
                                        <td class="text-center"><input type="checkbox" name="data[IndividualAgenda][checkbox][]" value="<?php echo $item['id']; ?>"  id="checkBoxRow" class="styled checkboxDeleteRow" /></td>
