<?php echo $this->Form->create("IndividualAgendas", array("class" => "form-horizontal form-separate", "action" => "edit", "id" => "formSubmit", "inputDefaults" => array("error" => array("attributes" => array("wrap" => "label", "class" => "error"))))) ?>
<div class="row">
    <div class="col-lg-12 col-md-6">
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="block-inner text-danger">
                    <h6 class="heading-hr"><?= __("Agenda Perusahaan") ?>
                    </h6>
                </div>
...
?>
                element.find(".close").click(function () {
                    isDelete = true;
                    $("#agenda-modal-delete .judul-deskripsi").html('<div class="row">\n\
...
<script>
    $(document).ready(function () {
        $("#add").click(function () {
            ...
            var all_day = 0;
            if (title != '') {
                startAdd = $.fullCalendar.formatDate(startAdd, "yyyy-MM-dd HH:mm:ss");
                endAdd = $.fullCalendar.formatDate(endAdd, "yyyy-MM-dd HH:mm:ss");
                if (allDayAdd) {
                    allDayAdd = 1;
                }
                $.ajax({
                    url: BASE_URL + "admin/individual_agendas/calender_add",
                    data: {"data[IndividualAgenda][description]": description, "data[IndividualAgenda][title]": title, "data[IndividualAgenda][start]": startAdd, "data[IndividualAgenda][end]": endAdd, "data[IndividualAgenda][all_day]": allDayAdd},
                    type: "POST",
                    dataType: "json",
                    success: function (json) {
                        ...
                        calendar.fullCalendar('renderEvent', {
                            ...
                            allDay: allDayAdd,
                            id: json.data.individual_agenda_id,
                        },
                                true);
        ...
        $("#edit").click(function () {
            ...
            if (newTitle) {
                ...
                $.ajax({
                    url: BASE_URL + "admin/individual_agendas/calender_edit/" + currentEvent.id,
                    data: {"data[IndividualAgenda][id]": id, "data[IndividualAgenda][description]": newDescription, "data[IndividualAgenda][title]": newTitle, "data[IndividualAgenda][start]": start, "data[IndividualAgenda][end]": end, "data[IndividualAgenda][all_day]": currentEvent.all_day},
                    type: "POST",
                    dataType: "json",
                    success: function (json) {
        ...
        $("#delete").click(function () {
            ...
            $.ajax({
                type: "DELETE",
                url: BASE_URL + "admin/individual_agendas/calender_delete/" + currentEvent.id,
                data: {"data[IndividualAgenda][id]": currentEvent.id, "data[IndividualAgenda][description]": currentEvent.description, "data[IndividualAgenda][title]": currentEvent.title, "data[IndividualAgenda][start]": currentEvent.start, "data[IndividualAgenda][end]": currentEvent.end, "data[IndividualAgenda][all_day]": currentEvent.all_day},
                dataType: "json",
                success: function (json) {
