<?php echo $this->Form->create("IndividualAgenda", array("class" => "form-horizontal form-separate", "action" => "add", "id" => "formSubmit", "inputDefaults" => array("error" => array("attributes" => array("wrap" => "label", "class" => "error"))))) ?>
<div class="panel panel-default">
    <div class="panel-body">
        <div class="block-inner text-danger">
            <h6 class="heading-hr"><?= __("Tambah Data Agenda Perusahaan") ?>
            </h6>
        </div>
        <div class="row">
            <div class="col-md-6">
                        ...
                        <tr>
                            <td colspan="3" style="width:200px">
                                <div class="form-group">
                                    ...
                                    echo $this->Form->input("IndividualAgenda.employee_id", array("div" => array("class" => "col-sm-9 col-md-8"), "type" => "hidden", "label" => false, "class" => "form-control"));
                                    ?>
                                </div>
                            </td>
                        </tr>
