            ...
            <div class="panel-body">
                ...
                <div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="input-group">
                                ...
                                <?php
                                echo $this->Form->input("MaterialAdditional.price", array("div" => array("class" => ""), "label" => false, "class" => "form-control text-right", "value" => str_replace(".00", "", $this->data['MaterialAdditional']['price'])));
                                ?>
                    ...
                    <div class="form-group">
                        ...
                        ?>
                        <?php
                        echo $this->Form->label("MaterialAdditional.product_id", __("Produk"), array("class" => "col-md-2 control-label"));
                        echo $this->Form->input("MaterialAdditional.product_id", array("div" => array("class" => "col-md-4"), "label" => false, "class" => "select-full", 'empty' => "", 'placeholder' => "- Pilih Produk -"));
                        ?> 
                    </div>
                </div>
            </div>
