<?php
echo $this->element(_TEMPLATE_DIR . "/{$template}/filter/expenditure-type");
?>
<div class="panel panel-default">
    <div class="panel-body">
        <div class="block-inner text-danger">
            <h6 class="heading-hr"><?= __("DATA JENIS PENGELUARAN") ?>
    ...
    <div class="modal-dialog modal-lg-6">
        <div class="modal-content">
            ...
            <div class="panel form-horizontal">
                <div class="panel-body">
                    <div class="block-inner text-danger">
                        <h6 class="heading-hr">LIHAT DATA JENIS PENGELUARAN
                            ...
                            <tr>
                                <td colspan="3" style="width:200px">
                                    <div class="form-group">
                                        ...
                                        echo $this->Form->input("ExpenditureType.name", array("div" => array("class" => "col-sm-9 col-md-8"), "label" => false, "class" => "form-control", "disabled"));
                                        ?>
                                    </div>
                                </td>
                            </tr>
...
<script>
    $(document).ready(function () {
        $(".viewData").click(function () {
            ...
            $.ajax({
                url: BASE_URL + "expenditure_types/view_expenditure_type/" + typeId,
                type: "GET",
                dataType: "JSON",
                data: {},
                success: function (data) {
                    $("#ExpenditureTypeName").val(data.ExpenditureType.name);
                }
            })
        });
    });
