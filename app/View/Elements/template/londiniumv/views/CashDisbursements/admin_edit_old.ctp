<?php echo $this->Form->create("CashDisbursement", array("class" => "form-horizontal form-separate", "type" => "file", "action" => "edit", "id" => "formSubmit", "inputDefaults" => array("error" => array("attributes" => array("wrap" => "label", "class" => "error"))))) ?>
<div class="panel panel-default">
    <div class="panel-body">
        <div class="block-inner text-danger">
            <h6 class="heading-hr"><?= __("FORM UBAH KAS KELUAR") ?>                
                                ...
                                <tr>
                                    <td colspan="11" style="width:200px">
                                        <div class="form-group">
                                            ...
                                            echo $this->Form->input("CashDisbursement.created_datetime", array("div" => array("class" => "col-sm-4"), "type" => "text", "label" => false, "class" => "form-control datepicker"));
                                            ?>
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td colspan="11" style="width:200px">
                                        <div class="form-group">     
                                            ...
                                            echo $this->Form->input("CashDisbursement.initial_balance_id", array("div" => array("class" => "col-sm-4"), "options" => $initialBalances, "label" => false, "class" => "select-full", "empty" => "--Pilih Kas Yang Digunakan--", "disabled"));
                                            ?>
                                        </div>
                                    </td>
                                </tr>
                    ...
                    <div class="tab-pane fade" id="justified-pill3">
                        <table class="table table-hover table-bordered stn-table" width="100%">
                            ...
                            <tbody id="target-detail-kas-keluar">
                                <?php
                                $no = 1;
                                $dataN = count($this->data["CashDisbursementDetail"]);
                                foreach ($this->data["CashDisbursementDetail"] as $i => $value) {
                                    ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                            echo $this->Form->input("CashDisbursementDetail.$i.id", array("div" => false, "label" => false, "type" => "hidden", "class" => false));
                                            echo $this->Form->input("CashDisbursementDetail.$i.expenditure_type_id", array("div" => false, "label" => false, "class" => "select-full", "empty" => "", "placeholder" => "- Pilih Jenis Pengeluaran -"));
                                            ?>
                                        </td>
                                        <td>
                                            <div class="input-group">
                                                ...
                                                <?php
                                                echo $this->Form->input("CashDisbursementDetail.$i.amount", array("div" => false, "label" => false, "type" => "text", "class" => "form-control text-right isdecimal"));
                                                ?>
                                                <span class="input-group-btn">
                                        ...
                                        <td>
                                            <?= $this->Form->input("CashDisbursementDetail.$i.date", array("div" => false, "label" => false, "class" => "form-control datepicker text-right", "type" => "text")) ?>
                                        </td>
                                        <td>
                                            <input type="file" name="data[CashDisbursementDetail][<?= $i ?>][gambar]" class="form-control">
                                        </td>
...
<script type="x-tmpl-mustache" id="tmpl-detail-kas-keluar">
    ...
    <td>
    <select class="select-full" name="data[CashDisbursementDetail][{{n}}][expenditure_type_id]" id = "CashDisbursementDetail{{n}}expenditure_type_id" placeholder="- Pilih Jenis Pengeluaran -">
    {{#expenditureTypes}}
    ...
    <input type="text" class="form-control text-right isdecimal" name="data[CashDisbursementDetail][{{n}}][amount]" id="CashDisbursementDetail{{n}}amount">
    <span class="input-group-btn">
    <button class="btn btn-default" type="button">,00.</button>
    </span>
    </div>
    ...
    <td>
    <input name="data[CashDisbursementDetail][{{n}}][date]" id="CashDisbursementDetail{{n}}date" class="form-control datepicker text-right" maxlength="255" type="text">                                    
    </td>
    <td>
    <input type="file" name="data[CashDisbursementDetail][{{n}}][gambar]" id="CashDisbursementDetail{{n}}gambar" class="form-control">                                   
    </td>
    <td class="text-center">
    <a href="javascript:void(false)" onclick="deleteThisRow($(this))"><i class="icon-remove3"></i></a>
    </td>
