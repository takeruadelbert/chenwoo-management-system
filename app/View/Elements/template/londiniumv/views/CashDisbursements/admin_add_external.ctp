<?php echo $this->Form->create("CashDisbursement", array("class" => "form-horizontal form-separate", "type" => "file", "action" => "add_external", "id" => "formSubmit", "inputDefaults" => array("error" => array("attributes" => array("wrap" => "label", "class" => "error"))))) ?>
                                ...
                                <tr>
                                    <td colspan="11" style="width:200px">
                                        <div class="form-group">     
                                            ...
                                            echo $this->Form->input("CashDisbursement.general_entry_type_id", array("div" => array("class" => "col-sm-4"), "options" => $generalEntryTypeDollars, "label" => false, "class" => "select-full", "empty" => "", "placeholder" => "-- Pilih Jenis Pengeluaran --"));
                                            ?>
                                        </div>
                                    </td>
                                </tr>
...
<script type="x-tmpl-mustache" id="tmpl-detail-kas-keluar">
    ...
    <td>
    <input name="data[CashDisbursementDetail][{{n}}][date]" class="form-control datepicker text-right" maxlength="255" type="text">                                    
    </td>
    <td>
