        ...
        <div class="block-inner text-danger">
            <h6 class="heading-hr"><?= __("DATA KAS KELUAR") ?>
                <div class="pull-right">
                    ...
                    <a href="<?= Router::url("/admin/{$this->params['controller']}/add_multiple_coa", true) ?>">
                            ...
                            foreach ($data['rows'] as $item) {
                                ...
                                <tr id="row-<?= $i ?>" class="removeRow<?php echo $item[Inflector::classify($this->params['controller'])]['id']; ?>">
                                    ...
                                    <td class="text-center"> 
                                        <a data-toggle="modal" data-target="#default-view-cash-disbursement" role="button" href="<?= Router::url("/admin/popups/content?content=viewcashdisbursement_multiplecoa&id={$item[Inflector::classify($this->params['controller'])]['id']}") ?>" class="ajax-modal btn btn-default btn-xs btn-icon btn-icon tip" title="Lihat Data Kas Keluar"><i class="icon-eye7"></i></a>
