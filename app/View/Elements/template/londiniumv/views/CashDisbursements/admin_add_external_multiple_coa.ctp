<?php echo $this->Form->create("CashDisbursement", array("class" => "form-horizontal form-separate", "type" => "file", "action" => "add_external_multiple_coa", "id" => "formSubmit", "inputDefaults" => array("error" => array("attributes" => array("wrap" => "label", "class" => "error"))))) ?>
                                ...
                                <tr>
                                    <td colspan="11" style="width:200px">
                                        <div class="form-group">
                                            ...
                                            echo $this->Form->input("CashDisbursement.transaction_currency_type_id", ["type" => "hidden", "value" => 2]);
                                            ?>
                                            <?php
                                            echo $this->Form->label("CashDisbursement.created_datetime", __("Tanggal Dibuat"), array("class" => "col-sm-2 control-label"));
                                            echo $this->Form->input("CashDisbursement.created_datetime", array("div" => array("class" => "col-sm-4"), "type" => "text", "label" => false, "class" => "form-control datepicker", "value" => date("Y-m-d")));
                                            ?>
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td colspan="11" style="width:200px">
                                        <div class="form-group">     
                                            ...
                                            echo $this->Form->input("CashDisbursement.initial_balance_id", array("div" => array("class" => "col-sm-4"), "options" => $initialBalanceDollars, "label" => false, "class" => "select-full", "empty" => "", "placeholder" => "-- Pilih Kas Yang Digunakan --"));
                                            ?>
                                            ...
                                            <div class="col-md-4">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control text-right isdecimal" name="data[CashDisbursement][exchange_rate]">
                                                    <span class="input-group-btn">
                        ...
                        <table class="table table-hover table-bordered stn-table" width="100%">
                            ...
                            <tbody id="target-detail-kas-keluar">
                                <tr>
                                    ...
                                    <td>
                                        <?= $this->Form->input("CashDisbursementDetail.0.general_entry_type_id", array("div" => false, "label" => false, "class" => "select-full", "empty" => "", "placeholder" => "- Pilih COA -", "value" => $generalEntryTypes, "id" => "coa0", "onchange" => "validate_coa(0)")) ?>
                                    </td>
                                    <td>
                                        <div class="input-group">
                                            <span class="input-group-btn">
                                            ...
                                            <input type="text" class="form-control text-right isdecimaldollar" name="data[CashDisbursementDetail][0][amount]">
                                        </div>
                                    </td>
                                    <td>
        ...
        $.ajax({
            ...
            success: function(response) {
                if(response.status == 200) {
                    if(response.data != 2) {
                        notif("warning", "Tipe Mata Uang COA Harus Dollar.", "growl");
                        $("#coa" + i).select2("val", "");
                        return false;
                    }
                }
...
<script type="x-tmpl-mustache" id="tmpl-detail-kas-keluar">
    ...
    <td>
    <select name="data[CashDisbursementDetail][{{n}}][general_entry_type_id]" class="select-full" id="coa{{i}}" onchange="validate_coa({{i}})">
    ...
    <input type="text" class="form-control text-right isdecimaldollar" name="data[CashDisbursementDetail][{{n}}][amount]">
    </div>
    </td>
    <td>
