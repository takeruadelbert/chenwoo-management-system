<?php
echo $this->element(_TEMPLATE_DIR . "/{$template}/filter/employee-data-deposit");
?>
                                ...
                                <tr id="row-<?= $i ?>" class="removeRow<?php echo $item[Inflector::classify($this->params['controller'])]['id']; ?>">
                                    ...
                                    <td class="text-center"  id = "target-change-status<?= $i ?>">
                                        ...
                                        if ($item['EmployeeDataDeposit']['verify_status_id'] == 2) {
                                            ...
                                            echo $this->Html->changeStatusSelect($item['EmployeeDataDeposit']['id'], ClassRegistry::init("VerifyStatus")->find("list", array("fields" => array("VerifyStatus.id", "VerifyStatus.name"))), $item['EmployeeDataDeposit']['verify_status_id'], Router::url("/admin/employee_data_deposits/change_status_verify"), "#target-change-status$i");
                                        }
                                        ?>
                                    </td>
