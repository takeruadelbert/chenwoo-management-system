<?php echo $this->Form->create("EmployeeDataDeposit", array("class" => "form-horizontal form-separate", "action" => "add", "id" => "formSubmit", "inputDefaults" => array("error" => array("attributes" => array("wrap" => "label", "class" => "error"))))) ?>
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="block-inner text-danger">
                    <h6 class="heading-hr"><?= __("Tambah Data Simpanan Pegawai") ?>
                ...
                <div class="well block">
                    <div class="tabbable">
                        <ul class="nav nav-pills nav-justified">
                            ...
                            <li><a href="#justified-pill3" data-toggle="tab"><i class="icon-file"></i>Data Simpanan</a></li>
                        </ul>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">                                    
                                                        ...
                                                        echo $this->Form->input("EmployeeDataDeposit.account_number", array("disabled" => true, "type" => "text", "div" => array("class" => " col-md-8"), "label" => false, "class" => "form-control", "id" => "accountNumber"));
                                                        ?>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class=" col-md-8">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control text-right" name="data[EmployeeDataDeposit][deposit_previous_balance]" readonly id="previousBalance">
                                        ...
                                        <td>
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">                                    
                                                        <?php
                                                        echo $this->Form->label("EmployeeDataDeposit.transaction_date", __("Waktu Penyimpanan"), array("class" => "col-md-4 control-label"));
                                        ...
                                        <td>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <?php
                                                        echo $this->Form->label("EmployeeDataDeposit.cooperative_cash_id", __("Kas Tujuan"), array("class" => "col-md-4 control-label"));
            ...
            success: function (response) {
                if (response.status == 206) {
                    if (!response.data.is_new) {
                        ...
                        $("#previousBalance").val(IDR(0));
                        $("#accountNumber").val("Auto generate");
                        $("#accountNumber").attr("disabled");
                    }
                } else {
