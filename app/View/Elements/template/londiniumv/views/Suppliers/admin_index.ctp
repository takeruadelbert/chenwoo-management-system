                        ...
                        if (empty($data['rows'])) {
                            ...
                            foreach ($data['rows'] as $item) {
                                ...
                                <tr id="row-<?= $i ?>" class="removeRow<?php echo $item["Supplier"]['id']; ?>">
                                    ...
                                    <td class="text-left"><?php echo $this->Echo->empty_strip($item["Supplier"]['address']); ?></td>
                                    <td class="text-left"><?php echo $this->Echo->empty_strip($item["State"]['name']); ?></td>
                                    <td class="text-left"><?php echo $this->Echo->empty_strip($item["City"]['name']); ?></td>
                                    <td class="text-left"><?php echo $this->Echo->empty_strip($item["Country"]['name']); ?></td>
                                    <td class="text-left"><?php echo $this->Echo->empty_strip($item["Supplier"]['phone_number']); ?></td>
                                    <td class="text-left"><?php echo $this->Echo->empty_strip($item["Supplier"]['email']); ?></td>
                                    <td class="text-left"><?php echo $this->Echo->empty_strip($item["Supplier"]['website']); ?></td>
