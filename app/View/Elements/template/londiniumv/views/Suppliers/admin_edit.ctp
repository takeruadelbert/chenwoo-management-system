<?php echo $this->Form->create("Supplier", array("class" => "form-horizontal form-separate", "action" => "edit", "type" => "file", "id" => "formSubmit", "inputDefaults" => array("error" => array("attributes" => array("wrap" => "label", "class" => "error"))))) ?>
<div class="tab-pane active fade in" id="data-utama">
    <div class="panel panel-default">
        <div class="panel-body">
            <div class="block-inner text-danger">
                <h6 class="heading-hr"><?= __("Ubah Supplier") ?>
                                    ...
                                    <tr>
                                        <td colspan="11" style="width:200px">
                                            <div class="form-group">
                                                ...
                                                echo $this->Form->input("Supplier.email", array("div" => array("class" => "col-sm-4"), "label" => false, "class" => "form-control"));
                                                ?>
                                                <?php
                        ...
                        <div class="tab-pane fade" id="justified-pill3">
                            <table class="table table-hover table-bordered stn-table" width="100%">
                                ...
                                <tbody id="target-detail-perbankan-supplier">
                                    ...
                                    foreach ($this->data["SupplierBank"] as $i => $value) {
                                        ...
                                        <tr class="dynamic-row">
                                            ...
                                            <td>
                                                ...
                                                echo $this->Form->input("SupplierBank.$i.bank_name", array("div" => false, "label" => false, "class" => "form-control", "maxlength" => "255"));
                                                ?>
                                            </td>
                                            <td>
                                                <?php
                                                echo $this->Form->input("SupplierBank.$i.bank_code", array("div" => false, "label" => false, "class" => "form-control", "maxlength" => "255"));
                                                ?>
                                            </td>
                                            <td>
                                                <?php
                                                echo $this->Form->input("SupplierBank.$i.bank_branch", array("div" => false, "label" => false, "class" => "form-control", "maxlength" => "255"));
                                                ?>
                                            </td>
                                            <td>
                                                <?php
                                                echo $this->Form->input("SupplierBank.$i.on_behalf", array("div" => false, "label" => false, "class" => "form-control", "maxlength" => "255"));
                                                ?>
                                            </td>
                                    ...
                                    <tr>
                                        <td colspan="6">
                                            <a class="text-success dataN0" href="javascript:void(false)" onclick="addThisRow($(this), 'detail-perbankan-supplier', 'anakOptions')"  data-n="<?= $dataN ?>"><i class="icon-plus-circle"></i></a>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                        ...
                        <div class="tab-pane fade" id="justified-pill4">
                            <table class="table table-hover table-bordered stn-table" width="100%">
                                ...
                                <tbody id="target-detail-kas-keluar">
                                    ...
                                    <tr>
                                        <td colspan="3">
                                            <a class="text-success dataN0" href="javascript:void(false)" onclick="addThisRow($(this), 'detail-kas-keluar', 'anakOptions')"  data-n="<?= $dataN ?>"><i class="icon-plus-circle"></i></a>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
