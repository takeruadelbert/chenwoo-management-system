<?php
echo $this->element(_TEMPLATE_DIR . "/{$template}/filter/role");
?>
<div class="panel panel-default">
    <div class="panel-body">
        ...
        <div class="table-responsive pre-scrollable stn-table" style = "max-height: 1000px !important">
                ...
                <table width="100%" class="table table-hover table-bordered">
                    ...
                    <tbody>
                        ...
                        if (empty($data['rows'])) {
                            ?>
                            <tr>
                                <td class="text-center" colspan="4">Filter Terlebih Dahulu</td>
                            </tr>
                            <?php
                        } else {
