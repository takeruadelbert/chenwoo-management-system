<?php echo $this->Form->create("OutgoingMail", array("class" => "form-horizontal form-separate", "type" => "file", "action" => "edit", "id" => "formSubmit", "inputDefaults" => array("error" => array("attributes" => array("wrap" => "label", "class" => "error"))))) ?>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                echo $this->Form->input("OutgoingMail.mail_type_id", array("div" => array("class" => "col-md-8"), "label" => false, "class" => "select-full", "empty" => "- Pilih Jenis Surat -"));
                                ?>
                            </div>
                            <div class="form-group">
                                <?php
                                echo $this->Form->label("OutgoingMail.mail_classification_id", __("Klasifikasi Surat"), array("class" => "col-md-4 control-label"));
                                echo $this->Form->input("OutgoingMail.mail_classification_id", array("div" => array("class" => "col-md-8"), "label" => false, "class" => "select-full", "empty" => "- Pilih Klasifikasi Surat -"));
                                ?>
                            </div>
                            <div class="form-group">
                                <?php
                                echo $this->Form->label("OutgoingMail.mail_rack_id", __("Rak Surat"), array("class" => "col-md-4 control-label"));
                                echo $this->Form->input("OutgoingMail.mail_rack_id", array("div" => array("class" => "col-md-8"), "label" => false, "class" => "select-full", "empty" => "- Pilih Rak Surat -"));
                                ?>
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                ?>
                                <div class="col-sm-8">
                                    <textarea rows="5" cols="5" class="limited form-control" placeholder="Limited to 100 characters" name="data[OutgoingMail][catatan]"><?= $this->data['OutgoingMail']['catatan'] ?></textarea>
