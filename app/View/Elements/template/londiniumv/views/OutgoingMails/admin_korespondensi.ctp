    ...
    <div class="panel panel-default">
        <div class="panel-body">
            <div class="block-inner text-danger">
                <h6 class="heading-hr">KORESPONDENSI SURAT KELUAR 
                    <div class="pull-right">
                        <button class="btn btn-xs btn-default" type="button" onclick="exp('print', '<?php echo Router::url("korespondensi/{$result[0]["OutgoingMail"]['id']}/print?" . $_SERVER['QUERY_STRING'], true) ?>')"><i class="icon-print2"></i> Print</button>
                        &nbsp;
                        <button class="btn btn-xs btn-default" type="button" onclick="exp('excel', '<?php echo Router::url("korespondensi/{$result[0]["OutgoingMail"]['id']}/excel?" . $_SERVER['QUERY_STRING'], true) ?>')"><i class="icon-file-excel"></i> Excel</button>
                    </div>
                ...
                <table width="100%" class="table table-bordered">
                    <tbody>
                        <tr>
                            ...
                            <td width="34%"><?= $result[0]['OutgoingMail']['nomor_agenda'] ?></td>
                            <td width="1%" rowspan="2">&nbsp;</td>
                            <td width="15%">Pengirim</td>
                            <td width="1%" align="center">:</td>
                            <td width="34%"><?= $result[0]['OutgoingMail']['pengirim'] ?></td>
                        </tr>
                        <tr>
                            <td>Nomor Surat</td>
                            <td align="center" valign="middle">:</td>
                            <td><?= $result[0]['OutgoingMail']['nomor_surat'] ?></td>
                            <td>Perihal</td>
                            <td align="center">:</td>
                            <td><?= $result[0]['OutgoingMail']['perihal'] ?></td>
                        </tr>
                    </tbody></table>
            </div>
            <br>
