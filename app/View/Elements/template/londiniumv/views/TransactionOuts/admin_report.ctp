<?php echo $this->Form->create("TransactionOut", array("class" => "form-horizontal form-separate", "action" => "report", "type" => "file", "id" => "formSubmit", "inputDefaults" => array("error" => array("attributes" => array("wrap" => "label", "class" => "error"))))) ?>
