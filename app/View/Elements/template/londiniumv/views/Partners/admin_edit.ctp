<?php echo $this->Form->create("Partner", array("class" => "form-horizontal form-separate", "action" => "edit", "type" => "file", "id" => "formSubmit", "inputDefaults" => array("error" => array("attributes" => array("wrap" => "label", "class" => "error"))))) ?>
<div class="tab-pane active fade in" id="data-utama">
    <div class="panel panel-default">
        <div class="panel-body">
            <div class="block-inner text-danger">
                <h6 class="heading-hr"><?= __("Ubah Partner") ?>
                        ...
                        <div class="tab-pane fade" id="justified-pill3">
                            <table class="table table-hover table-bordered stn-table" width="100%">
                                ...
                                <tbody id="target-detail-perbankan-partner"><?php
                                    ...
                                    foreach ($this->data["PartnerBank"] as $i => $value) {
                                        ...
                                        <tr class="dynamic-row">
                                            ...
                                            <td>
                                                ...
                                                echo $this->Form->input("PartnerBank.$i.bank_name", array("div" => false, "label" => false, "class" => "form-control", "maxlength" => "255"));
                                                ?>
                                            </td>
                                            <td>
                                                <?php
                                                echo $this->Form->input("PartnerBank.$i.bank_code", array("div" => false, "label" => false, "class" => "form-control", "maxlength" => "255"));
                                                ?>
                                            </td>
                                            <td>
                                                <?php
                                                echo $this->Form->input("PartnerBank.$i.bank_branch", array("div" => false, "label" => false, "class" => "form-control", "maxlength" => "255"));
                                                ?>
                                            </td>
                                            <td>
                                                <?php
                                                echo $this->Form->input("PartnerBank.$i.on_behalf", array("div" => false, "label" => false, "class" => "form-control", "maxlength" => "255"));
                                                ?>
                                            </td>
                                    ...
                                    <tr>
                                        <td colspan="6">
                                            <a class="text-success dataN0" href="javascript:void(false)" onclick="addThisRow($(this), 'detail-perbankan-partner', 'anakOptions')" data-n="<?= $dataN ?>"><i class="icon-plus-circle"></i></a>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
