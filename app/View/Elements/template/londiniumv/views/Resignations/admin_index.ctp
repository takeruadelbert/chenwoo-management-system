<?php
echo $this->element(_TEMPLATE_DIR . "/{$template}/filter/resignation");
?>
<div class="panel panel-default">
    <div class="panel-body">
        <div class="block-inner text-danger">
            <h6 class="heading-hr"><?= __("DATA PEGAWAI KELUAR") ?>
                        ...
                        if (empty($data['rows'])) {
                            ...
                            foreach ($data['rows'] as $item) {
                                ...
                                <tr id="row-<?= $i ?>" class="removeRow<?php echo $item[Inflector::classify($this->params['controller'])]['id']; ?>">
                                    ...
                                    <td class = "text-left"><?= !empty($item['Employee']['Office']['id']) ? $item['Employee']['Office']['name'] : "-" ?> </td>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a target="_blank" href="<?= Router::url("/admin/attendances/absensi_kehadiran_per_pegawai?employee_id={$item['Employee']['id']}") ?>"><button type="button" class="btn btn-default btn-xs btn-icon tip" title="Lihat Absensi Pegawai"><i class="icon-file-check"></i></button></a>
                                        <a target="_blank" href="<?= Router::url("/admin/resignations/laporan_kehadiran_pegawai_keluar?employee_id={$item['Employee']['id']}") ?>"><button type="button" class="btn btn-default btn-xs btn-icon tip" title="Lihat Absensi Pegawai Keluar Harian"><i class="icon-profile"></i></button></a>
                                    </td>
                                </tr>
                                <?php
                                $i++;
