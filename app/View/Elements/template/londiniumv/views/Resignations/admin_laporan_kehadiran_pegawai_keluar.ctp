<?php
echo $this->element(_TEMPLATE_DIR . "/{$template}/filter/laporan-kehadiran-pegawai-keluar");
if (isset($result)) {
            ...
            <div class="block-inner text-danger">
                <h6 class="heading-hr"><?= __("DATA KEHADIRAN PEGAWAI") ?>
                    <div class="pull-right">
                        <button class="btn btn-xs btn-default" type="button" onclick="exp('print', '<?php echo Router::url("laporan_kehadiran_pegawai_keluar/print?" . $_SERVER['QUERY_STRING'], true) ?>')">
                            <i class="icon-print2"></i> 
                            <?= __("Cetak") ?>
                        </button>&nbsp;
                        <button class="btn btn-xs btn-default" type="button" onclick="exp('excel', '<?php echo Router::url("laporan_kehadiran_pegawai_keluar/excel?" . $_SERVER['QUERY_STRING'], true) ?>')">
