<?php
echo $this->element(_TEMPLATE_DIR . "/{$template}/filter/cooperative-item-loan-payment");
?>
                            ...
                            foreach ($data['rows'] as $item) {
                                ...
                                <tr id="row-<?= $i ?>" class="removeRow<?php echo $item[Inflector::classify($this->params['controller'])]['id']; ?>">
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a target="_blank" href="<?= Router::url("/admin/{$this->params['controller']}/view/{$item[Inflector::classify($this->params['controller'])]['id']}/print", true) ?>" class="btn btn-default btn-xs btn-icon btn-icon tip" title="Print"><i class="icon-print2"></i></a>
                                    </td>
                                </tr>
                                <?php
                                $i++;
