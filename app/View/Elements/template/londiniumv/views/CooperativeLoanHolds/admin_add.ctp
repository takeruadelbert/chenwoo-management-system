<?php echo $this->Form->create("CooperativeLoanHold", array("class" => "form-horizontal form-separate", "action" => "add", "id" => "formSubmit", "inputDefaults" => array("error" => array("attributes" => array("wrap" => "label", "class" => "error"))))) ?>
<?= $this->Form->hidden("CooperativeLoanHold.creator_id", ["value" => $stnAdmin->getEmployeeId()]) ?>
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="block-inner text-danger">
                    <h6 class="heading-hr"><?= __("Tambah Keringanan Penundaan Pembayaran Kasbon") ?>
