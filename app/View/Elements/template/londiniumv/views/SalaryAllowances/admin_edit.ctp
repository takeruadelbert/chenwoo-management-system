<?php echo $this->Form->create("SalaryAllowance", array("class" => "form-horizontal form-separate", "action" => "edit", "id" => "formSubmit", "inputDefaults" => array("error" => array("attributes" => array("wrap" => "label", "class" => "error"))))) ?>
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="block-inner text-danger">
                    <h6 class="heading-hr"><?= __("Edit Tunjangan Pegawai") ?>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            echo $this->Form->input("SalaryAllowance.employee_id", array("div" => array("class" => "col-sm-8"), "label" => false, "class" => "select-full", "empty" => "", "placeholder" => "-Pilih Pegawai-", "disabled"));
                            echo $this->Form->input("SalaryAllowance.employee_id", ['type' => "hidden"]);
                            ?>
                        </div>
                    </div>
                </div>
                ...
                <table width="100%" class="table table-bordered table-hover">
                    ...
                    <tbody id="target-salaryAllowanceDetail">
                        <?php
                        $i = 1;
                        foreach ($this->data['SalaryAllowanceDetail'] as $index => $details) {
                            ?>
                            <tr>
                                <td class="text-center nomorIdx"><?= $i ?></td>
                                <td>
                                    <?= $this->Form->input("SalaryAllowanceDetail.$index.parameter_salary_id", array("label" => false, "class" => "select-full", "data-placeholder" => "- Pilih Tunjangan -", "empty" => "", "value" => $details['parameter_salary_id'])); ?>
                                </td>
                                <td>
                                    <div class="input-group">
                                        <span class="input-group-addon">Rp.</span>
                                        <input name="data[SalaryAllowanceDetail][<?= $index ?>][amount]" class="form-control text-right isdecimal" maxlength="255" type="text" required="required" value="<?= $details['amount'] ?>">
                                ...
                                <input type="hidden" name="data[SalaryAllowanceDetail][<?= $index ?>][id]" value="<?= $details['id'] ?>">
                            </tr>
                        <?php
                        $i++;
                    }
                    ...
                    <tfoot>
                        <tr class="addrowborder">
                            <td colspan="4" align="left"><a href="javascript:void(false)" onclick="addThisRow($(this), 'salaryAllowanceDetail', 'salaryAllowanceDetailOptions')" data-n="<?= $i ?>"><i class="icon-plus-circle"></i></a></td>
                        </tr>
                    </tfoot>
                </table>
            </div>
