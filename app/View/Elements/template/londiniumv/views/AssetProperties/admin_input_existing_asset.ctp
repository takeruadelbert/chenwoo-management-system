<?php echo $this->Form->create("AssetProperty", array("class" => "form-horizontal form-separate", "action" => "input_existing_asset", "id" => "formSubmit", "inputDefaults" => array("error" => array("attributes" => array("wrap" => "label", "class" => "error"))))) ?>
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    echo $this->Form->input("AssetProperty.general_entry_type_id", array("div" => array("class" => "col-md-4"), "label" => false, "class" => "select-full", "empty" => "", "placeholder" => "- Pilih COA Aset -"));
                    ?>
                </div>
                <div class="form-group">
                    <?php
                    echo $this->Form->label("AssetProperty.capital_id", __("COA Modal"), array("class" => "col-md-2 control-label"));
                    echo $this->Form->input("AssetProperty.capital_id", array("div" => array("class" => "col-md-4"), "label" => false, "class" => "select-full", "empty" => "", "placeholder" => "- Pilih Tipe Aset -"));
                    ?>
                    <?php
