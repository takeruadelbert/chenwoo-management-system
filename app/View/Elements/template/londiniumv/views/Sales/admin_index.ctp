        ...
        <div class="block-inner text-danger">
            <h6 class="heading-hr"><?= __("DATA PENJUALAN PRODUK") ?>
                <div class="pull-right">
                    ...
                    <a href="<?= Router::url("/admin/{$this->params['controller']}/sale_setup", true) ?>">
                        ...
                        if (empty($data['rows'])) {
                            ...
                            foreach ($data['rows'] as $item) {
                                ...
                                <tr id="row-<?= $i ?>" class="removeRow<?php echo $item["Sale"]['id']; ?>">
                                    ...
                                    <td class="text-left"><?php echo emptyToStrip(@$item['Buyer']["BuyerType"]['name']); ?></td>
                ...
                success: function (data) {
                    ...
                    if (data.Buyer.buyer_type_id == 1) {
                        ...
                        $.each(emp, function (index, value) {
                            ...
                            var weight = ac_dollar(value.nett_weight);
