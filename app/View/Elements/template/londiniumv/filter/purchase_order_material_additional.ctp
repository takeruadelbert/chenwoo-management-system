                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="has-feedback">
                            <?php
                            $employees = "";
                            if (isset($this->request->query['RequestOrderMaterialAdditional_employee_id'])) {
                                $employees = ClassRegistry::init("Employee")->find("first", [
                                    "conditions" => [
                                        "Employee.id" => $this->request->query['RequestOrderMaterialAdditional_employee_id']
                                    ],
                                    "contain" => [
                                        "Account" => [
                                            "Biodata"
                            ...
                            <input type="hidden" name="RequestOrderMaterialAdditional.employee_id" id="employee">
