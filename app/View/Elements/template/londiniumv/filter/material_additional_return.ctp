    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="has-feedback">
                            <?php
                            $employee = "";
                            if (isset($this->request->query['select_MaterialAdditionalReturn_employee_id'])) {
                                $employee = ClassRegistry::init("Employee")->find("first", [
                                    "conditions" => [
                                        "Employee.id" => $this->request->query['select_MaterialAdditionalReturn_employee_id']
                                    ],
                                    "contain" => [
                                        "Account" => [
                                            "Biodata"
                            ...
                            <input type="hidden" name="select.MaterialAdditionalReturn.employee_id" id="employee">
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-md-3">
                        <label><?= __("Periode Penjualan") ?></label>
                        <?= $this->Form->input(null, ["default" => isset($this->request->query['awal_Sale_created']) ? $this->request->query['awal_Sale_created'] : '', "name" => "awal.Sale.created", "class" => "form-control datepicker", "id" => "startDate", "div" => false, "label" => false, "placeholder" => "Awal Periode"]) ?>
                    </div>
                    <div class="col-md-3">
                        <label>&nbsp;</label>
                        <?= $this->Form->input(null, ["default" => isset($this->request->query['akhir_Sale_created']) ? $this->request->query['akhir_Sale_created'] : '', "name" => "akhir.Sale.created", "class" => "form-control datepicker", "id" => "endDate", "div" => false, "label" => false, "placeholder" => "Akhir Periode"]) ?>
                    </div>
                    <div class="col-md-6">
                        <label><?= __("Status Pengembalian") ?></label>
                        <?= $this->Form->input(null, ["default" => isset($this->request->query['select_MaterialAdditionalReturn_verify_status_id']) ? $this->request->query['select_MaterialAdditionalReturn_verify_status_id'] : 0, "name" => "select.MaterialAdditionalReturn.verify_status_id", "options" => $verifyStatuses, "class" => "select-full", "div" => false, "label" => false, "empty" => "", "placeholder" => "- Semua -"]) ?>
                    </div>
                </div>
            </div>
            <div class="form-group">
