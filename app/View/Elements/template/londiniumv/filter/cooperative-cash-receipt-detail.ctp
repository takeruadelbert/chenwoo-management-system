            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <?= $this->Form->input(null, ["default" => isset($this->request->query['CooperativeGoodList_name']) ? $this->request->query['CooperativeGoodList_name'] : "", "name" => "CooperativeGoodList.name", "class" => "form-control", "type" => "text", "div" => false, "label" => false]) ?>
                    </div>
                    <div class="col-md-3">
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <?= $this->Form->input(null, ["default" => isset($this->request->query['select_CooperativeCashReceipt_branch_office_id']) ? $this->request->query['select_CooperativeCashReceipt_branch_office_id'] : '', "name" => "CooperativeCashReceipt.branch_office_id", "class" => "select-full", "div" => false, "label" => false, "options" => $branchOffices, "empty" => "", "placeholder" => "- Semua -"]) ?>
                    </div>
                </div>
            </div>
