            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <?= $this->Form->input(null, ["div" => false, "label" => false, "class" => "select-full", "name" => "select.DepartmentNews.department_id", "default" => isset($this->request->query['select_DepartmentNews_department_id']) ? $this->request->query['select_DepartmentNews_department_id'] : "", "empty" => "", "placeholder" => "- Pilih Departemen -", "options" => $departments]) ?>
                    </div>
                </div>
            </div>
