            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <?= $this->Form->input(null, ["default" => isset($this->request->query['awal_CooperativeCashDisbursement_created_date']) ? $this->request->query['awal_CooperativeCashDisbursement_created_date'] : '', "name" => "awal.CooperativeCashDisbursement.created_date", "class" => "form-control datepicker", "id" => "startDate", "div" => false, "label" => false]) ?>
                    </div>
                    <div class="col-md-6">
                        <label><?= __("Tanggal Akhir Dibuat") ?></label>
                        <?= $this->Form->input(null, ["default" => isset($this->request->query['akhir_CooperativeCashDisbursement_created_date']) ? $this->request->query['akhir_CooperativeCashDisbursement_created_date'] : '', "name" => "akhir.CooperativeCashDisbursement.created_date", "class" => "form-control datepicker", "id" => "endDate", "div" => false, "label" => false]) ?>
                    </div>
                </div>
            </div>
            <div class="form-group">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <?= $this->Form->input(null, ["default" => isset($this->request->query['select_CooperativeCashDisbursement_verify_status_id']) ? $this->request->query['select_CooperativeCashDisbursement_verify_status_id'] : "", "name" => "select.CooperativeCashDisbursement.verify_status_id", "options" => $verifyStatuses, "class" => "select-full", "div" => false, "label" => false, "empty" => "", "placeholder" => "- Semua -"]) ?>
                    </div>
                    <div class="col-md-6">
