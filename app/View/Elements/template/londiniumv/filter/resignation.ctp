        ...
        <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="has-feedback">
                            <?php
                            $employee = "";
                            if (isset($this->request->query['select_Resignation_employee_id'])) {
                                $employee = ClassRegistry::init("Employee")->find("first", [
                                    "conditions" => [
                                        "Employee.id" => $this->request->query['select_Resignation_employee_id']
                                    ],
                                    "contain" => [
                                        "Account" => [
                                            "Biodata"
                            ...
                            <input type="hidden" name="select.Resignation.employee_id" id="employee">
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <label><?= __("Jenis Pengunduran Diri") ?></label>
                        <?= $this->Form->input(null, ["default" => isset($this->request->query['select_Resignation_resignation_type_id']) ? $this->request->query['select_Resignation_resignation_type_id'] : '', "name" => "select.Resignation.resignation_type_id", "class" => "select-full", "div" => false, "label" => false, "options" => $resignationTypes, "empty" => "", "placeholder" => "- Semua -"]) ?>
                    </div>
                    <div class="col-md-3">
                        <label><?= __("Periode Pengunduran Diri") ?></label>
                        <?= $this->Form->input(null, ["default" => isset($this->request->query['awal_Resignation_resignation_date']) ? $this->request->query['awal_Resignation_resignation_date'] : '', "name" => "awal.Resignation.resignation_date", "class" => "form-control datepicker", "id" => "startDate", "div" => false, "label" => false, "placeholder" => "Awal Periode"]) ?>
                    </div>
                    <div class="col-md-3">
                        <label><?= __("&nbsp;") ?></label>
                        <?= $this->Form->input(null, ["default" => isset($this->request->query['akhir_Resignation_resignation_date']) ? $this->request->query['akhir_Resignation_resignation_date'] : '', "name" => "akhir.Resignation.resignation_date", "class" => "form-control datepicker", "id" => "endDate", "div" => false, "label" => false, "placeholder" => "Akhir Periode"]) ?>
                    </div>
                </div>
            </div>
            <div class="form-group">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <?= $this->Form->input(null, ["default" => isset($this->request->query['select_Resignation_verify_status_id']) ? $this->request->query['select_Resignation_verify_status_id'] : '', "name" => "select.Resignation.verify_status_id", "class" => "select-full", "div" => false, "label" => false, "options" => $verifyStatuses, "empty" => "", "placeholder" => "- Semua -"]) ?>
                    </div>
                    <div class="col-md-6">
