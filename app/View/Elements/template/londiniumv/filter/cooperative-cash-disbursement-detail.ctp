            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <?= $this->Form->input(null, ["default" => isset($this->request->query['CooperativeGoodList_name']) ? $this->request->query['CooperativeGoodList_name'] : "", "name" => "CooperativeGoodList.name", "class" => "form-control", "type" => "text", "div" => false, "label" => false, "placeholder" => "Ketik Nama Barang"]) ?>
                    </div>
                    <div class="col-md-3">
