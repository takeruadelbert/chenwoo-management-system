    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-md-3">
                        <label><?= __("Periode Input Penjualan") ?></label>
                    ...
                    <div class="col-md-6">
                        <label><?= __("Status Packaging") ?></label>
                        <?= $this->Form->input(null, ["div" => false, "label" => false, "class" => "select-full", "name" => "select.Sale.packaging_status_id", "default" => isset($this->request->query['select_Sale_packaging_status_id']) ? $this->request->query['select_Sale_packaging_status_id'] : "", "options" => $packagingStatuses, "empty" => "", "placeholder" => "- Semua -"]) ?>
                    </div>
                </div>
            </div>
            <div class="form-group">
