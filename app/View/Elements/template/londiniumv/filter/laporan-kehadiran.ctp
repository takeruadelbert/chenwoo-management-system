            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <?= $this->Form->input(null, ["options" => $employees, "name" => "Laporan.pegawai", "class" => "select-full", "div" => false, "label" => false, "empty" => "", "placeholder" => "- Semua -"]) ?>
                    </div>
                    <div class="col-md-6">
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <?= $this->Form->input(null, ["name" => "Laporan.tanggal_awal", "class" => "form-control datepicker", "div" => false, "label" => false]) ?>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <?= $this->Form->input(null, ["name" => "Laporan.tanggal_akhir", "class" => "form-control datepicker", "div" => false, "label" => false]) ?>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
