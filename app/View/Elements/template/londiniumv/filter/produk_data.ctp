            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <?= $this->Form->input(null, ["div" => false, "label" => false, "class" => "form-control tip", "type" => "text", "name" => "ProductData.serial_number", "default" => isset($this->request->query['ProductData_serial_number']) ? $this->request->query['ProductData_serial_number'] : ""]) ?>
                    </div>
                    <div class="col-md-6">
                        <label><?= __("Nama Produk Size") ?></label>
