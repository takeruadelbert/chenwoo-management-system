            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <?= $this->Form->input(null, ["default" => isset($this->request->query['select_Buyer_buyer_type_id']) ? $this->request->query['select_Buyer_buyer_type_id'] : '', "name" => "select.Buyer.buyer_type_id", "class" => "select-full", "div" => false, "label" => false, "options" => $buyerTypes, "empty" => "", "placeholder" => "- Semua -"]) ?>
                    </div>
                </div>
            </div>
            <div class="form-group">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <?= $this->Form->input(null, ["default" => isset($this->request->query['select_Sale_verify_status_id']) ? $this->request->query['select_Sale_verify_status_id'] : '', "name" => "select.Sale.verify_status_id", "class" => "select-full", "div" => false, "label" => false, "options" => $verifyStatuses, "empty" => "", "placeholder" => "- Semua -"]) ?>
                    </div>
                    <div class="col-md-6">
...
<script>
    ...
    $(document).ready(function () {
        var sale = new Bloodhound({
            ...
            prefetch: false,
            remote: {
                url: '<?= Router::url("/admin/sales/list", true) ?>' + '?q=%QUERY&type=validate',
                wildcard: '%QUERY',
            }
        });
        sale.clearRemoteCache();
