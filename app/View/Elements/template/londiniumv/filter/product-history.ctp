        ...
        <div class="panel-body">
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <label><?= __("Tipe") ?></label>
                        <?= $this->Form->input(null, ["div" => false, "label" => false, "class" => "select-full", "name" => "select.ProductHistory.product_history_type_id", "default" => isset($this->request->query['select_ProductHistory_product_history_type_id']) ? $this->request->query['select_ProductHistory_product_history_type_id'] : "", "empty" => "", "placeholder" => "- Semua -", "options" => $productHistoryTypes]) ?>
                    </div>
                </div>
            </div>
            <div class="form-group">
