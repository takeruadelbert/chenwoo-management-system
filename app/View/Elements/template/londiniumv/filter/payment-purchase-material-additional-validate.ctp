            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <?= $this->Form->input(null, ["default" => isset($this->request->query['select_PaymentPurchaseMaterialAdditional_branch_office_id']) ? $this->request->query['select_PaymentPurchaseMaterialAdditional_branch_office_id'] : '', "name" => "select.PaymentPurchaseMaterialAdditional.branch_office_id", "class" => "select-full", "div" => false, "label" => false, "options" => $branchOffices, "empty" => "", "placeholder" => "- Semua -"]) ?>
                    </div>
                </div>
            </div>
