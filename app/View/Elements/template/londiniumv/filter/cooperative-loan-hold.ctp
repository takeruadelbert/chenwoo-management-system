            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <?= $this->Form->input(null, ["default" => isset($this->request->query['CooperativeLoanHold_start_period']) ? $this->request->query['CooperativeLoanHold_start_period'] : "", "name" => "CooperativeLoanHold.start_period", "class" => "form-control datepicker", "id" => "startDate", "type" => "text", "div" => false, "label" => false, "placeholder" => "Awal Periode"]) ?>
                    </div>
                    <div class="col-md-3">
                        <label><?= __("&nbsp;") ?></label>
                        <?= $this->Form->input(null, ["default" => isset($this->request->query['CooperativeLoanHold_end_period']) ? $this->request->query['CooperativeLoanHold_end_period'] : "", "name" => "CooperativeLoanHold.end_period", "class" => "form-control datepicker", "id" => "endDate", "type" => "text", "div" => false, "label" => false, "placeholder" => "Akhir Periode"]) ?>
                    </div>
                </div>
            </div>
