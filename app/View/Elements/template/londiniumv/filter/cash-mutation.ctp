        ...
        <div class="panel-body">
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <label><?= __("Periode Mutasi Kas") ?></label>
                        <?= $this->Form->input(null, ["type" => "text", "div" => false, "label" => false, "class" => "form-control datetime", "default" => isset($this->request->query["awal_CashMutation_transfer_date"]) ? $this->request->query['awal_CashMutation_transfer_date'] : "", "name" => "awal.CashMutation_transfer_date", "id" => "startDate", "placeholder" => "Awal Periode"]) ?>
                    </div>
                    <div class="col-md-3">
                        <label><?= __("&nbsp;") ?></label>
                        <?= $this->Form->input(null, ["type" => "text", "div" => false, "label" => false, "class" => "form-control datetime", "default" => isset($this->request->query["akhir_CashMutation_transfer_date"]) ? $this->request->query['akhir_CashMutation_transfer_date'] : "", "name" => "akhir_CashMutation_transfer_date", "id" => "endDate", "placeholder" => "Akhir Periode"]) ?>
                    </div>
                </div>
            </div>
            <div class="form-group">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <?= $this->Form->input(null, ["div" => false, "label" => false, "class" => "form-control", "default" => isset($this->request->query["CashMutation_note"]) ? $this->request->query['CashMutation_note'] : "", "name" => "CashMutation.note", "placeholder" => "Keterangan ..."]) ?>
                    </div>
                </div>
            </div>
