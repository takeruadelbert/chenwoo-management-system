    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="has-feedback">
                            ...
                            <input type="hidden" name="EmployeeDataDeposit.employee_id" id="employee">
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-md-6">
                        <label><?= __("Tanggal Awal Simpanan") ?></label>
                        <?= $this->Form->input(null, ["default" => isset($this->request->query['EmployeeDataDeposit_start_date']) ? $this->request->query['EmployeeDataDeposit_start_date'] : "", "name" => "EmployeeDataDeposit.start_date", "class" => "form-control datepicker", "id" => "startDate", "type" => "text", "div" => false, "label" => false]) ?>
                    </div>
                    <div class="col-md-6">
                        <label><?= __("Tanggal Akhir Simpanan") ?></label>
                        <?= $this->Form->input(null, ["default" => isset($this->request->query['EmployeeDataDeposit_end_date']) ? $this->request->query['EmployeeDataDeposit_end_date'] : "", "name" => "EmployeeDataDeposit.end_date", "class" => "form-control datepicker", "id" => "endDate", "type" => "text", "div" => false, "label" => false]) ?>
                    </div>
                </div>
            </div>
