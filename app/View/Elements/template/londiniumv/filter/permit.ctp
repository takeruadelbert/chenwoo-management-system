            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <?= $this->Form->input(null, ["default" => isset($this->request->query['select_Permit_permit_status_id']) ? $this->request->query['select_Permit_permit_status_id'] : 0, "name" => "select.Permit.permit_status_id", "options" => $permitStatuses, "class" => "select-full", "div" => false, "label" => false, "empty" => "", "placeholder" => "- Semua -"]) ?>
                    </div>
                </div>
            </div>
            <div class="form-group">
