        ...
        <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="has-feedback">
                            <?php
                            $employee = "";
                            if (isset($this->request->query['select_Pension_employee_id'])) {
                                $employee = ClassRegistry::init("Employee")->find("first", [
                                    "conditions" => [
                                        "Employee.id" => $this->request->query['select_Pension_employee_id']
                                    ],
                                    "contain" => [
                                        "Account" => [
                                            "Biodata"
                            ...
                            <input type="hidden" name="select.Pension.employee_id" id="employee">
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <label><?= __("Jenis Pensiun") ?></label>
                        <?= $this->Form->input(null, ["default" => isset($this->request->query['select_Pension_pension_type_id']) ? $this->request->query['select_Pension_pension_type_id'] : '', "name" => "select.Pension.pension_type_id", "class" => "select-full", "div" => false, "label" => false, "options" => $pensionTypes, "empty" => "", "placeholder" => "- Semua -"]) ?>
                    </div>
                    <div class="col-md-3">
                        <label><?= __("Periode Pensiun") ?></label>
                        <?= $this->Form->input(null, ["default" => isset($this->request->query['awal_Pension_tanggal_sk']) ? $this->request->query['awal_Pension_tanggal_sk'] : '', "name" => "awal.Pension.tanggal_sk", "class" => "form-control datepicker", "id" => "startDate", "div" => false, "label" => false, "placeholder" => "Awal Periode"]) ?>
                    </div>
                    <div class="col-md-3">
                        <label><?= __("&nbsp;") ?></label>
                        <?= $this->Form->input(null, ["default" => isset($this->request->query['akhir_Pension_tanggal_sk']) ? $this->request->query['akhir_Pension_tanggal_sk'] : '', "name" => "akhir.Pension.tanggal_sk", "class" => "form-control datepicker", "id" => "endDate", "div" => false, "label" => false, "placeholder" => "Akhir Periode"]) ?>
                    </div>
                </div>
            </div>
            <div class="form-group">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <?= $this->Form->input(null, ["default" => isset($this->request->query['select_Pension_verify_status_id']) ? $this->request->query['select_Pension_verify_status_id'] : '', "name" => "select.Pension.verify_status_id", "class" => "select-full", "div" => false, "label" => false, "options" => $verifyStatuses, "empty" => "", "placeholder" => "- Semua -"]) ?>
                    </div>
                    <div class="col-md-6">
