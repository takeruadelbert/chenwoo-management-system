            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <?= $this->Form->input(null, ["default" => isset($this->request->query['select_TransferEmployee_verify_status_id']) ? $this->request->query['select_TransferEmployee_verify_status_id'] : 0, "name" => "select.TransferEmployee.verify_status_id", "options" => $verifyStatuses, "class" => "select-full", "div" => false, "label" => false, "empty" => "", "placeholder" => "- Semua -"]) ?>
                    </div>
                    <div class="col-md-6">
