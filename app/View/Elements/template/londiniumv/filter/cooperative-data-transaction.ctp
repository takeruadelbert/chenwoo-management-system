            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <?= $this->Form->input(null, ["div" => false, "label" => false, "class" => "select-full", "default" => isset($this->request->query["select_CooperativeTransactionMutation_cooperative_transaction_type_id"]) ? $this->request->query['select_CooperativeTransactionMutation_cooperative_transaction_type_id'] : "", "name" => "select.CooperativeTransactionMutation.cooperative_transaction_type_id", "options" => $cooperativeTransactionTypes, "empty" => "", "placeholder" => "- Semua -"]) ?>
                    </div>                  
                </div>
            </div>
            <div class="form-group">
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <?= $this->Form->input(null, ["type" => "text", "div" => false, "label" => false, "class" => "form-control datepicker", "default" => isset($this->request->query["awal_CooperativeTransactionMutation_transaction_date"]) ? $this->request->query['awal_CooperativeTransactionMutation_transaction_date'] : "", "name" => "awal.CooperativeTransactionMutation.transaction_date", "id" => "startDate","placeholder"=>"Periode Awal"]) ?>
                    </div>
                    <div class="col-md-3">
                        <label><?= __("&nbsp;") ?></label>
                        <?= $this->Form->input(null, ["type" => "text", "div" => false, "label" => false, "class" => "form-control datepicker", "default" => isset($this->request->query["akhir_CooperativeTransactionMutation_transaction_date"]) ? $this->request->query['akhir_CooperativeTransactionMutation_transaction_date'] : "", "name" => "akhir.CooperativeTransactionMutation.transaction_date", "id" => "endDate","placeholder"=>"Periode Akhir"]) ?>
                    </div>
                    <div class="col-md-6">
