    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="has-feedback">
                            ...
                            <input type="hidden" name="EmployeeDataLoan.employee_id" id="employee">
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-md-6">
                        <label><?= __("Tanggal Awal Pinjaman") ?></label>
                        <?= $this->Form->input(null, ["default" => isset($this->request->query['EmployeeDataLoan_start_date']) ? $this->request->query['EmployeeDataLoan_start_date'] : "", "name" => "EmployeeDataLoan.start_date", "class" => "form-control datepicker", "id" => "startDate", "type" => "text", "div" => false, "label" => false]) ?>
                    </div>
                    <div class="col-md-6">
                        <label><?= __("Tanggal Akhir Pinjaman") ?></label>
                        <?= $this->Form->input(null, ["default" => isset($this->request->query['EmployeeDataLoan_end_date']) ? $this->request->query['EmployeeDataLoan_end_date'] : "", "name" => "EmployeeDataLoan.end_date", "class" => "form-control datepicker", "id" => "endDate", "type" => "text", "div" => false, "label" => false]) ?>
                    </div>
                </div>
            </div>
