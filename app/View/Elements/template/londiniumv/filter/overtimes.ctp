                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="has-feedback">
                            <?php
                            $employee = "";
                            if (isset($this->request->query['select_Overtime_employee_id'])) {
                                $employee = ClassRegistry::init("Employee")->find("first", [
                                    "conditions" => [
                                        "Employee.id" => $this->request->query['select_Overtime_employee_id']
                                    ],
                                    "contain" => [
                                        "Account" => [
                                            "Biodata"
                            ...
                            <input type="hidden" name="select.Overtime.employee_id" id="employee">
                            <i class="icon-search3 form-control-feedback"></i>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <label><?= __("Periode Lembur") ?></label>
                        <?= $this->Form->input(null, ["default" => isset($this->request->query['awal_Overtime_overtime_date']) ? $this->request->query['awal_Overtime_overtime_date'] : '', "name" => "awal.Overtime.overtime_date", "class" => "form-control datepicker", "div" => false, "label" => false, "type" => "text", "placeholder" => "Awal Periode"]) ?>
                    </div>
                    <div class="col-md-3">
                        <label><?= __("&nbsp;") ?></label>
                        <?= $this->Form->input(null, ["default" => isset($this->request->query['akhir_Overtime_overtime_date']) ? $this->request->query['akhir_Overtime_overtime_date'] : '', "name" => "akhir.Overtime.overtime_date", "class" => "form-control datepicker", "div" => false, "label" => false, "type" => "text", "placeholder" => "Akhir Periode"]) ?>
                    </div>
                </div>
            </div>
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <?= $this->Form->input(null, ["default" => isset($this->request->query['select_Employee_department_id']) ? $this->request->query['select_Employee_department_id'] : '', "name" => "select.Employee.department_id", "class" => "select-full", "div" => false, "label" => false, "options" => $departments, "empty" => "", "placeholder" => "- Semua -"]) ?>
                    </div>
                    <div class="col-md-6">
                        <label><?= __("Status Validasi HR") ?></label>
                        <?= $this->Form->input(null, ["default" => isset($this->request->query['select_Overtime_validate_status_id']) ? $this->request->query['select_Overtime_validate_status_id'] : 0, "name" => "select.Overtime.validate_status_id", "options" => $validateStatuses, "class" => "select-full", "div" => false, "label" => false, "empty" => "", "placeholder" => "- Semua -"]) ?>
                    </div>
                </div>
            </div>
            <div class="form-group">
