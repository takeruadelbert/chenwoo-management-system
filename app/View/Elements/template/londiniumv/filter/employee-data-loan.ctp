        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <?= $this->Form->input(null, ["default" => isset($this->request->query['awal_EmployeeDataLoan_date']) ? $this->request->query['awal_EmployeeDataLoan_date'] : "", "name" => "awal.EmployeeDataLoan.date", "class" => "form-control datepicker", "id" => "startDate", "type" => "text", "div" => false, "label" => false, "placeholder" => "Awal Periode"]) ?>
                    </div>
                    <div class="col-md-3">
                        <label><?= __("&nbsp;") ?></label>
                        <?= $this->Form->input(null, ["default" => isset($this->request->query['akhir_EmployeeDataLoan_date']) ? $this->request->query['akhir_EmployeeDataLoan_date'] : "", "name" => "akhir.EmployeeDataLoan.date", "class" => "form-control datepicker", "id" => "endDate", "type" => "text", "div" => false, "label" => false, "placeholder" => "Akhir Periode"]) ?>
                    </div>
                    <div class="col-md-6">
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <?= $this->Form->input(null, ["default" => isset($this->request->query['select_EmployeeDataLoan_verify_status_id']) ? $this->request->query['select_EmployeeDataLoan_verify_status_id'] : '', "name" => "select.EmployeeDataLoan.verify_status_id", "class" => "select-full", "div" => false, "label" => false, "options" => $verifyStatuses, "empty" => "", "placeholder" => "- Semua -"]) ?>
                    </div>
                    <div class="col-md-6">
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <label><?= __("Tipe Pinjaman") ?></label>
                        <?= $this->Form->input(null, ["default" => isset($this->request->query['EmployeeDataLoan_cooperative_loan_type_id']) ? $this->request->query['EmployeeDataLoan_cooperative_loan_type_id'] : '', "name" => "EmployeeDataLoan.cooperative_loan_type_id", "class" => "select-full", "div" => false, "label" => false, "options" => $cooperativeLoanTypes, "empty" => "", "placeholder" => "- Semua -"]) ?>
                    </div>
                </div>
            </div>
