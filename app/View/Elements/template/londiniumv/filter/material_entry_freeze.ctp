        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <label><?= __("Status Styling") ?></label>
                        <?= $this->Form->input(null, ["div" => false, "label" => false, "class" => "select-full", "name" => "select.MaterialEntry.freezing_status_id", "default" => isset($this->request->query['select_MaterialEntry_freezing_status_id']) ? $this->request->query['select_MaterialEntry_freezing_status_id'] : "", "options" => $materialProcessingStatuses, "empty" => "", "placeholder" => "- Semua -"]) ?>
                    </div>
                </div>
            </div>
            <div class="form-group">
