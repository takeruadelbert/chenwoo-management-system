            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <?= $this->Form->input(null, ["default" => isset($this->request->query['select_DebitInvoicePurchaserMaterialAdditional_verify_status_id']) ? $this->request->query['select_DebitInvoicePurchaserMaterialAdditional_verify_status_id'] : "", "name" => "select.DebitInvoicePurchaserMaterialAdditional.verify_status_id", "empty" => "", "placeholder" => "-- Semua --", "options" => $verifyStatuses, "class" => "select-full", "div" => false, "label" => false]) ?>
                    </div>
                </div>
            </div>
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <?= $this->Form->input(null, ['label' => false, 'div' => false, 'class' => "select-full", 'name' => "select.PurchaseOrderMaterialAdditional.material_additional_supplier_id", "default" => isset($this->request->query['select_PurchaseOrderMaterialAdditional_material_additional_supplier_id']) ? $this->request->query['select_PurchaseOrderMaterialAdditional_material_additional_supplier_id'] : "", 'options' => $materialAdditionalSuppliers, 'empty' => "", "placeholder" => "- Pilih Nama Supplier -"]) ?>
                    </div>
                </div>
            </div>
