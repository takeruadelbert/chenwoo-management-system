    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="form-group">
                <div class="row">
                    <div class="col-md-6">
                        <label><?= __("Tanggal Pengemasan") ?></label>
                        <?= $this->Form->input(null, ["type" => "text", "div" => false, "label" => false, "class" => "form-control datepicker", "default" => isset($this->request->query["PackageDetail_date"]) ? $this->request->query['PackageDetail_date'] : "", "name" => "PackageDetail.date"]) ?>
                    </div>
                    <div class="col-md-6">
