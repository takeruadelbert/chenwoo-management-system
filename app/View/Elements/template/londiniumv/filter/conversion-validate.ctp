            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <?= $this->Form->input(null, ["default" => isset($this->request->query['awal_MaterialEntry_weight_date']) ? $this->request->query['awal_MaterialEntry_weight_date'] : "", "name" => "awal.MaterialEntry.weight_date", "class" => "form-control datepicker", "id" => "startDateMaterialEntry", "type" => "text", "div" => false, "label" => false]) ?>
                    </div>
                    <div class="col-md-3">
                        <label><?= __("&nbsp;") ?></label>
                        <?= $this->Form->input(null, ["default" => isset($this->request->query['akhir_MaterialEntry_weight_date']) ? $this->request->query['akhir_MaterialEntry_weight_date'] : "", "name" => "akhir.MaterialEntry.weight_date", "class" => "form-control datepicker", "id" => "endDateMaterialEntry", "type" => "text", "div" => false, "label" => false]) ?>
                    </div>
                </div>
            </div>
...
<script>
    ...
    $(document).ready(function () {
        var conversion = new Bloodhound({
            ...
            prefetch: '<?= Router::url("/admin/conversions/list", true) ?>',
            remote: {
                url: '<?= Router::url("/admin/conversions/list", true) ?>' + '?q=%QUERY',
                wildcard: '%QUERY',
            }
        });
...
<script>
    ...
    $(document).ready(function () {
        var material = new Bloodhound({
            ...
            queryTokenizer: Bloodhound.tokenizers.whitespace,
            prefetch: '<?= Router::url("/admin/material_entries/list_status/" + 1, true) ?>',
            remote: {
                url: '<?= Router::url("/admin/material_entries/list_status/" + 1, true) ?>' + '?q=%QUERY',
                wildcard: '%QUERY',
            }
        });
