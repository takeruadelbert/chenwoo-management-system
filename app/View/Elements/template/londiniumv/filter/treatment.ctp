    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="has-feedback">
                            <?php
                            $employee = "";
                            if (isset($this->request->query['select_Treatment_employee_id'])) {
                                $employee = ClassRegistry::init("Employee")->find("first", [
                                    "conditions" => [
                                        "Employee.id" => $this->request->query['select_Treatment_employee_id']
                                    ],
                                    "contain" => [
                                        "Account" => [
                                            "Biodata"
                    ...
                    <div class="col-md-3">
                        <label><?= __("Tanggal Mulai Treatment") ?></label>
                        <?= $this->Form->input(null, ["default" => isset($this->request->query['Treatment_start_date']) ? $this->request->query['Treatment_start_date'] : '', "name" => "Treatment.start_date", "class" => "form-control datepicker", "id" => "startDate", "div" => false, "label" => false, "placeholder" => "Tanggal Mulai Styling"]) ?>
                    </div>
                    <div class="col-md-3">
                        <label><?= __("Tanggal Selesai Styling") ?></label>
                        <?= $this->Form->input(null, ["default" => isset($this->request->query['Treatment_end_date']) ? $this->request->query['Treatment_end_date'] : '', "name" => "Treatment.end_date", "class" => "form-control datepicker", "id" => "endDate", "div" => false, "label" => false, "placeholder" => "Tanggal Selesai Styling"]) ?>
                    </div> 
                </div>
            </div>
            <div class="form-group">
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <?= $this->Form->input(null, ["default" => isset($this->request->query['select_Freeze_verify_status_id']) ? $this->request->query['select_Freeze_verify_status_id'] : '', "name" => "select.Freeze.verify_status_id", "class" => "select-full", "div" => false, "label" => false, "options" => $verifyStatuses, "empty" => "", "placeholder" => "- Semua -"]) ?>
                    </div>
                    <div class="col-md-3">
                        <label><?= __("Status Validasi") ?></label>
                        <?= $this->Form->input(null, ["default" => isset($this->request->query['select_Freeze_validate_status_id']) ? $this->request->query['select_Freeze_validate_status_id'] : '', "name" => "select.Freeze.validate_status_id", "class" => "select-full", "div" => false, "label" => false, "options" => $validateStatuses, "empty" => "", "placeholder" => "- Semua -"]) ?>
                    </div>
                    <div class="col-md-6">
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-md-3">
                        <label><?= __("Periode Tanggal Nota Timbang") ?></label>
                        <?= $this->Form->input(null, ["default" => isset($this->request->query['awal_MaterialEntry_weight_date']) ? $this->request->query['awal_MaterialEntry_weight_date'] : '', "name" => "awal.MaterialEntry.weight_date", "class" => "form-control datepicker", "id" => "startDateMaterialEntry", "div" => false, "label" => false, "placeholder" => "Awal Periode Tanggal Nota Timbang"]) ?>
                    </div>
                    <div class="col-md-3">
                        <label><?= __("&nbsp;") ?></label>
                        <?= $this->Form->input(null, ["default" => isset($this->request->query['akhir_MaterialEntry_weight_date']) ? $this->request->query['akhir_MaterialEntry_weight_date'] : '', "name" => "akhir.MaterialEntry.weight_date", "class" => "form-control datepicker", "id" => "endDateMaterialEntry", "div" => false, "label" => false, "placeholder" => "Awal Periode Tanggal Nota Timbang"]) ?>
                    </div>
                    <div class="col-md-6">
                        <div class="has-feedback">
                            <?php
...
<script>
    $(document).ready(function () {
        var dataTreatment = new Bloodhound({
            ...
            prefetch: '<?= Router::url("/admin/treatments/list_treatment", true) ?>',
            remote: {
                url: '<?= Router::url("/admin/treatments/list_treatment", true) ?>' + '?q=%QUERY',
                wildcard: '%QUERY',
            }
        });
