    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-md-6">
                        <label><?= __("Tanggal Timbang") ?></label>
                        <?= $this->Form->input(null, ["default" => isset($this->request->query['TransactionEntry_MaterialEntry_weight_date']) ? $this->request->query['TransactionEntry_MaterialEntry_weight_date'] : '', "name" => "TransactionEntry.MaterialEntry.weight_date", "class" => "form-control datepicker", "id" => "startDate", "div" => false, "label" => false, "placeholder" => "Periode Timbang"]) ?>
                    </div>
                    <div class="col-md-6">
                        <div class="has-feedback">
                            <?php
