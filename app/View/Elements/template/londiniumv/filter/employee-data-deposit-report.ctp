        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <label><?= __("Jenis Transaksi") ?></label>
                        <?= $this->Form->input(null, ["options" => $depositIoTypes, "default" => isset($this->request->query['select_EmployeeDataDeposit_deposit_io_type_id']) ? $this->request->query['select_EmployeeDataDeposit_deposit_io_type_id'] : "", "name" => "select.EmployeeDataDeposit.deposit_io_type_id", "class" => "select-full", "empty" => "", "placeholder" => "- Semua -", "div" => false, "label" => false]) ?>
                    </div>
                </div>
            </div>
            <div class="form-group">
                <div class="row">
                    <div class="col-md-3">
                        <label><?= __("Periode Penyimpanan") ?></label>
                        <?= $this->Form->input(null, ["default" => isset($this->request->query['awal_EmployeeDataDeposit_transaction_date']) ? $this->request->query['awal_EmployeeDataDeposit_transaction_date'] : "", "name" => "awal.EmployeeDataDeposit.transaction_date", "class" => "form-control datepicker", "id" => "startDate", "type" => "text", "div" => false, "label" => false, "placeholder" => "Periode Awal"]) ?>
                    </div>
                    <div class="col-md-3">
                        <label><?= __("&nbsp;") ?></label>
                        <?= $this->Form->input(null, ["default" => isset($this->request->query['akhir_EmployeeDataDeposit_transaction_date']) ? $this->request->query['akhir_EmployeeDataDeposit_transaction_date'] : "", "name" => "akhir.EmployeeDataDeposit.transaction_date", "class" => "form-control datepicker", "id" => "endDate", "type" => "text", "div" => false, "label" => false, "placeholder" => "Periode Akhir"]) ?>
                    </div>
                    <div class="col-md-6">
                        <label><?= __("Cabang Perusahaan") ?></label>
                        <?= $this->Form->input(null, ["default" => isset($this->request->query['select_Employee_branch_office_id']) ? $this->request->query['select_Employee_branch_office_id'] : '', "name" => "select.Employee.branch_office_id", "class" => "select-full", "div" => false, "label" => false, "options" => $branchOffices, "empty" => "", "placeholder" => "- Semuan -"]) ?>
                    </div>
                </div>
            </div>
