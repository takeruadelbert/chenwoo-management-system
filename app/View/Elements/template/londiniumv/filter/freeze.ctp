        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <label><?= __("Tanggal Mulai Styling") ?></label>
                        <?= $this->Form->input(null, ["default" => isset($this->request->query['Freeze_start_date']) ? $this->request->query['Freeze_start_date'] : '', "name" => "Freeze.start_date", "class" => "form-control datepicker", "id" => "startDate", "div" => false, "label" => false, "placeholder" => "Tanggal Mulai Styling"]) ?>
                    </div>
                    <div class="col-md-3">
                        <label><?= __("Tanggal Selesai Styling") ?></label>
                        <?= $this->Form->input(null, ["default" => isset($this->request->query['Freeze_end_date']) ? $this->request->query['Freeze_end_date'] : '', "name" => "Freeze.end_date", "class" => "form-control datepicker", "id" => "endDate", "div" => false, "label" => false, "placeholder" => "Tanggal Selesai Styling"]) ?>
                    </div>
                </div>
            </div>
            <div class="form-group">
