        ...
        <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="has-feedback">
                            <?php
                            $employee = "";
                            if (isset($this->request->query['select_MaterialAdditionalPerContainer_employee_id'])) {
                                $employee = ClassRegistry::init("Employee")->find("first", [
                                    "conditions" => [
                                        "Employee.id" => $this->request->query['select_MaterialAdditionalPerContainer_employee_id']
                                    ],
                                    "contain" => [
                                        "Account" => [
                                            "Biodata"
                            ...
                            <input type="hidden" name="select.MaterialAdditionalPerContainer.employee_id" id="employee">
                            <i class="icon-search3 form-control-feedback"></i>
                        </div>
                    </div>
                </div>
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <label><?= __("Status Gudang") ?></label>
                        <?= $this->Form->input(null, ["default" => isset($this->request->query['select_MaterialAdditionalPerContainer_verify_status_id']) ? $this->request->query['select_MaterialAdditionalPerContainer_verify_status_id'] : 0, "name" => "select.MaterialAdditionalPerContainer.verify_status_id", "options" => $verifyStatuses, "class" => "select-full", "div" => false, "label" => false, "empty" => "", "placeholder" => "- Semua -"]) ?>
                    </div>
                </div>
            </div>
            <div class="form-group">
