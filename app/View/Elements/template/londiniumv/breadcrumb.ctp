<div class="breadcrumb-line">
    <ul class="breadcrumb" style="background-color:#00589e !important">
    ...
    <ul class="breadcrumb-buttons" style="background-color:#00589e !important">
        <li class="dropdown" style="padding:9px 25px 10px;margin-top:5px">
            <div class="" style="color:white">
                1 SGD =
                <span><?= $this->Html->IDR($this->Html->getExchangeRate(1, "SGD", "IDR")) ?></span></div>
        </li>
        <li class="dropdown" style="padding:9px 25px 10px;margin-top:5px">
            <div class="" style="color:white">
                1 USD = 
                <span><?= $this->Html->IDR($this->Html->getExchangeRate(1, "USD", "IDR")) ?></span></div>
        </li>
        <li class="dropdown" style="padding:9px 25px 10px;margin-top:5px">
