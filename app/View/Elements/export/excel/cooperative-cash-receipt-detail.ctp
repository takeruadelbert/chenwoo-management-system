<div style="text-align: center">
    <div style="font-size:11px;font-weight: bold; font-family:Tahoma, Geneva, sans-serif;">
        Data Rincian Transaksi Penjualan Koperasi
    </div>
...
<table width="100%" class="table-data">
    <thead>
        <tr>
            ...
            <th colspan = "2" width="100"><?= __("Jumlah") ?></th>
    ...
    <tfoot>
        <tr>
            ...
            <td class="text-center" style = "border-right-style:none !important" width = "30">Rp. </td>
            <td class="text-right" style = "border-left-style:none !important" ><b><?= $this->Html->dotNumberSeperator(array_sum(array_column(array_column($data['rows'], "CooperativeCashReceiptDetail"), "total_amount"))) ?></b></td>
        </tr>
    </tfoot>
</table>