        ...
        if (empty($data['rows'])) {
            ...
            foreach ($data['rows'] as $item) {
                ...
                <tr>
                    ...
                    <td class="text-right" style = "border-left-style:none !important" width = "150"><?= $item['EmployeeDataDeposit']['amount'] ?></td>
                    <td class="text-center"><?= $item['EmployeeDataDeposit']['transaction_date'] ?></td>
