        ...
        if (empty($data['rows'])) {
            ...
            foreach ($data['rows'] as $item) {
                ...
                <tr>
                    ...
                    <td class="text-right" style ="border-right:none"><?= $item['ProductOpnameStock']['stock_number'] ?></td>
                    <td class="text-center" width = "30" style ="border-left:none"><?= $item['Product']['ProductUnit']['name'] ?></td>
                    <td class="text-right" style ="border-right:none"><?= $item['ProductOpnameStock']['stock_difference'] ?></td>
                    <td class="text-center" width = "30" style ="border-left:none"><?= $item['Product']['ProductUnit']['name'] ?></td>
