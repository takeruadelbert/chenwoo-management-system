<div style="text-align: center">
    <div style="font-size:11px;font-weight: bold; font-family:Tahoma, Geneva, sans-serif;">
        Data Penerimaan Kembalian Material Pembantu Validasi
    </div>
</div>
<br/>
        ...
        if (empty($data['rows'])) {
            ...
            foreach ($data['rows'] as $item) {
                ...
                <tr>
                    ...
                    <td class="text-right" style = "border-left-style:none !important" width = "150"><?= ($item['DebitInvoicePurchaserMaterialAdditional']['amount']) ?></td>
