...
<table width="100%" class="table-data">
    ...
    <tfoot>
        <tr>
            ...
            <td class="text-right" style = "border-left-style:none !important" width = "60"><b><?= $this->Html->dotNumberSeperator(array_sum(array_column(array_column($data['rows'], "CooperativeTransactionMutation"), "nominal"))) ?></b></td>
        </tr>
    </tfoot>
</table>