...
if (!empty($data['rows'])) {
    ...
    <h2 style="text-align: center">
        <?= $data['title'] ?> <br> <?= !empty($dataBranchOffice) ? "CABANG " . $dataBranchOffice['BranchOffice']['name'] : "SELURUH CABANG" ?>
    </h2>
    <table style="border:none !important; margin-top: 10px;">
        <tr style="border:none !important" width = "150px">
            ...
            <td class="text-right" style="border:none !important; font-size: 10px;">
