        ...
        if (empty($data['rows'])) {
            ...
            foreach ($data['rows'] as $item) {
                ...
                <tr>
                    ...
                    <td class="text-right" style = "border-left-style:none !important" width = "150"><?= $totalIncome ?></td>
                    <td class="text-center" style = "border-right-style:none !important" width = "50">Rp. </td>
                    <td class="text-right" style = "border-left-style:none !important" width = "150"><?= abs($totalDebt); ?></td>
