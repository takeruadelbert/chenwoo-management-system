        ...
        if (empty($data['rows'])) {
            ...
            foreach ($data['rows'] as $item) {
                ...
                <tr>
                    ...
                    <td class="text-right"><?php echo ($requestedMC); ?></td>
                    <td class="text-right" width = "30"> MC</td>
                    <td class="text-right"><?php echo ($requestedWeight); ?> </td>
                    <td class="text-right" width = "30"> Kg</td>
                    <td class="text-right"><span class="label label-<?= $fulFilledMC < $requestedMC ? "danger" : "success" ?>"><?= ($fulFilledMC); ?> </span></td>
                    <td class="text-right" width = "30"> MC</td>
                    <td class="text-right"><span class="label label-<?= $fulFilledWeight < $requestedWeight ? "danger" : "success" ?>"><?= ($fulFilledWeight); ?></span></td>
                    <td class="text-right" width = "30"> Kg</td>
                    <?php
                    if ($stnAdmin->branchPrivilege()) {
                        ?>
