...
<table width="100%" class="table-data">
        ...
        if (empty($data['rows'])) {
            ...
            foreach ($data['rows'] as $item) {
                ...
                <tr>
                    ...
                    <td class="text-right" style = "border-left-style:none !important" width = "150"><?= $item['CooperativeCashReceipt']['grand_total'] ?></td>
                </tr>
                <?php
                $i++;
            }
    ...
    <tfoot>
        <tr>
            ...
            <td class="text-center" style = "border-right-style:none !important" width = "30">Rp. </td>
            <td class="text-right" style = "border-left-style:none !important" ><b><?= array_sum(array_column(array_column($data['rows'], "CooperativeCashReceipt"), "grand_total")) ?></b></td>
        </tr>
    </tfoot>
</table>