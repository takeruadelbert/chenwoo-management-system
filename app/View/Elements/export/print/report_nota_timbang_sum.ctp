...
if (!empty($data['rows'])) {
    ...
    <table style="margin-top:10px; font-family:Tahoma, Geneva, sans-serif; font-size:11px;width:100%;white-space: nowrap" class="table-data"> 
        <tr style="font-weight:bold">
            ...
            <td width="30%"  class = "text-center" style="border: 1px solid">JENIS IKAN</td>
            <td width="5%" class = "text-center" style="border: 1px solid">GRADE</td>
            <td colspan="2" class = "text-center" style="border: 1px solid">JUMLAH IKAN</td>
            <td width="15%" class = "text-center" style="border: 1px solid">BRUTO</td>
            <td colspan="2" class = "text-center" style="border: 1px solid">NETTO</td>
        ...
        foreach ($data['rows']['MaterialEntryGrade'] as $transaction) {
            ...
            $totalBerat+=$transaction["weight"];
            $totalIkan += $transaction["quantity"];
            ?>
            <tr>
                ...
                <td width="5%" class = "text-right" style="border: 1px solid"><?= $transaction["quantity"] ?></td>
                <td width="1%" class = "text-left" style="border: 1px solid">Ekor</td>
                <td width="15%" class = "text-center" style="border: 1px solid"></td>
                <td width="15%" class = "text-right" style="border: 1px solid"><?= ic_kg($transaction['weight']) ?></td>
                <td width="1%" class = "text-left" style="border: 1px solid"><?= $transaction['MaterialDetail']['Unit']['uniq'] ?></td>
        ...
        ?> 
        <tr>
            <td colspan="3" style="border: 1px solid #000; text-align: right;"><strong>TOTAL</strong></td>
            <td width="15%" class = "text-right" style="border: 1px solid"><strong><?= $totalIkan ?></strong></td>
            <td width="1%" class = "text-left" style="border: 1px solid"><strong>Ekor</strong></td>
            <td width="15%" class = "text-center" style="border: 1px solid"></td>
            <td width="15%" class = "text-right" style="border: 1px solid"><strong><?= ic_kg($totalBerat) ?></strong></td>
            <td width="1%" class = "text-left" style="border: 1px solid"><strong>Kg</strong></td>
