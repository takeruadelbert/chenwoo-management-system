...
if (!empty($data['rows'])) {
    ...
    <div style="text-align:center">
        <div>DAILY FISH PROCESSING REPORT <br> CABANG <?= !empty($dataBranchOffice) ? "CABANG " . $dataBranchOffice['BranchOffice'] : "SELURUH CABANG" ?></div>
    </div>
    <br>
            ...
            foreach($arrayConversion as $conversion){
                ?>
                    <tr style="text-align:center;">
                        ...
                        ?>
                        <td><?= $no ?></td>
                        <td><?php if((($i+0)%13)<count($pieces)){$weight = $pieces[(($i+0)%13)];echo $weight;}; ?></td>  <!--1 -->
                        <td><?php if((($i+1)%13)<count($pieces)){$weight = $pieces[(($i+1)%13)];echo $weight;}; ?></td>  <!--2 -->
                        <td><?php if((($i+2)%13)<count($pieces)){$weight = $pieces[(($i+2)%13)];echo $weight;}; ?></td>  <!--3 -->
                        <td><?php if((($i+3)%13)<count($pieces)){$weight = $pieces[(($i+3)%13)];echo $weight;}; ?></td>  <!--4 -->
                        <td><?php if((($i+4)%13)<count($pieces)){$weight = $pieces[(($i+4)%13)];echo $weight;}; ?></td>  <!--5 -->
                        <td><?php if((($i+5)%13)<count($pieces)){$weight = $pieces[(($i+5)%13)];echo $weight;}; ?></td>  <!--6 -->
                        <td><?php if((($i+6)%13)<count($pieces)){$weight = $pieces[(($i+6)%13)];echo $weight;}; ?></td>  <!--7 -->
                        <td><?php if((($i+7)%13)<count($pieces)){$weight = $pieces[(($i+7)%13)];echo $weight;}; ?></td>  <!--8 -->
                        <td><?php if((($i+8)%13)<count($pieces)){$weight = $pieces[(($i+8)%13)];echo $weight;}; ?></td>  <!--9 -->
                        <td><?php if((($i+9)%13)<count($pieces)){$weight = $pieces[(($i+9)%13)];echo $weight;}; ?></td>  <!--10 -->
                        <td><?php if((($i+10)%13)<count($pieces)){$weight = $pieces[(($i+10)%13)];echo $weight;}; ?></td>  <!--11 -->
                        <td><?php if((($i+11)%13)<count($pieces)){$weight = $pieces[(($i+11)%13)];echo $weight;}; ?></td>  <!--12 -->
                        <td><?php if((($i+12)%13)<count($pieces)){$weight = $pieces[(($i+12)%13)];echo $weight;}; ?></td>  <!--13 -->
                        <?php
                        $no++;
                        }
                        ?>
