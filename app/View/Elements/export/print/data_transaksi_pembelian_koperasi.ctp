...
<table width="100%" class="table-data">
        ...
        if (empty($data['rows'])) {
            ...
            foreach ($data['rows'] as $item) {
                ...
                <tr>
                    ...
                    <td class="text-right" style = "border-left-style:none !important" width="60"><?= $item['CooperativeCashDisbursement']['grand_total__ic'] ?></td>
                </tr>
                <?php
    ...
    <tfoot>
        <tr>
            ...
            <td class="text-right" style = "border-left-style:none !important" width = "60"><b><?= $this->Html->dotNumberSeperator($total) ?></b></td>
            <!--<td class="text-right" style = "border-left-style:none !important" width = "60"><b><?= $this->Html->dotNumberSeperator(array_sum(array_column(array_column($data['rows'], "CooperativeCashReceipt"), "grand_total"))) ?></b></td>-->
        </tr>
    </tfoot>
</table>