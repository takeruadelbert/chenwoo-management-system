    ...
    <tr>
        <td style="padding: 0 0 0 0;">
            <table width="100%" class="table2">
                ...
                <tbody>
                    <tr>
                        <td style="border-left: none;"><?= $data['rows']['EmployeeBalance']['account_number'] ?></td>
...
<table width="100%" class="">
    ...
    <tr>
        <td>
            <table width="100%" class="table1">
                ...
                <tr>
                    <td colspan="2">Harap dibayarkan atas beban rekening tabungan di bawah ini</td>
                    <td>Tanggal : <?= $this->Html->cvtTanggal($data['rows']['EmployeeDataDeposit']['transaction_date']) ?></td>
                </tr>
                <tr>
                    <td><br></td>
                </tr>
    ...
    <tr>
        <td>
            <table width="100%" class="table1">
                <tr>
                    <td style="width:125px">Nomor Rekening</td>
                    <td style="width:25px">:</td>
                    <td><?= $data['rows']['EmployeeBalance']['account_number'] ?></td>
                </tr>
                <tr>
                    <td >Nama Pemilik</td>
                    <td>:</td>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td><?= $data['rows']['EmployeeDataDeposit']['amount__ic'] ?></td>
                </tr>
                <tr>
                    <td>Terbilang</td>
                    <td>:</td>
                ...
                <tr>
                    ...
                    <td class="text-right">Tanda Tangan Penabung</td>
                </tr>
                <tr>
                    <td><br><br><br></td>
                </tr>
                <tr>
                    <td colspan="3">SLIP PENGAMBILAN TABUNGAN</td>
                </tr>
                <tr>
                    <td><br></td>
                </tr>
